...
DIM 模式用于LED 设置 _闪烁_ 模式，该模式通过提供两个参数来指定：

  - period（周期）
	浠?0s 鍒?1.6s
  - duty cycle（占空比）：
	LED 点亮时间占周期的百分比，0 100

LED 设置DIM0 DIM1 模式会使其按照该模式闪烁。详见数据手册

LP3944 可在 Motorola A910 智能手机中找到，它驱rgb LED、相机闪光灯以及 lcd 的电源
