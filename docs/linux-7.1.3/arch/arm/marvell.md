...
本文档梳理 Linux 内核主线所支持的 ARM Marvell SoC（含 Orion、Kirkwood、Discovery 等系列），列出各型号、对应内核 mach/plat 目录及公开数据手册链接，帮助开发者确认具体芯片的支持情况。


本文档列出了当前由 Linux 内核主线所支持的全部 ARM Marvell SoC。由于 Marvell 各 SoC 系列规模庞大且复杂，很难弄清某个特定 SoC 在 Linux 内核中的支持情况。本文档试图帮助理解这些 SoC 在何处得到支持，并在有公开数据手册时将其与对应的公开数据手册相匹配。
...
### Kirkwood 系列
  ...
  型号：
        - 88F6282 a.k.a Armada 300
                ...
                - 产品简介  : https://web.archive.org/web/20111027032509/http://www.marvell.com/embedded-processors/armada-300/assets/armada_310.pdf
        - 88F6283 a.k.a Armada 310

                - 产品简介  : https://web.archive.org/web/20111027032509/http://www.marvell.com/embedded-processors/armada-300/assets/armada_310.pdf
        - 88F6190

                - 产品简介  : https://web.archive.org/web/20130730072715/http://www.marvell.com/embedded-processors/kirkwood/assets/88F6190-003_WEB.pdf
        ...
        - 88F6192
                ...
                - 产品简介  : https://web.archive.org/web/20131113121446/http://www.marvell.com/embedded-processors/kirkwood/assets/88F6192-003_ver1.pdf
                - 硬件规格  : https://web.archive.org/web/20121021182835/http://www.marvell.com/embedded-processors/kirkwood/assets/HW_88F619x_OpenSource.pdf
                - 功能规格: https://web.archive.org/web/20130730091033/http://www.marvell.com/embedded-processors/kirkwood/assets/FS_88F6180_9x_6281_OpenSource.pdf
        - 88F6182
        - 88F6180

                - 产品简介  : https://web.archive.org/web/20120616201621/http://www.marvell.com/embedded-processors/kirkwood/assets/88F6180-003_ver1.pdf
        ...
        - 88F6280
                ...
                - 产品简介  : https://web.archive.org/web/20130730091058/http://www.marvell.com/embedded-processors/kirkwood/assets/88F6280_SoC_PB-001.pdf
        - 88F6281

                - 产品简介  : https://web.archive.org/web/20120131133709/http://www.marvell.com/embedded-processors/kirkwood/assets/88F6281-004_ver1.pdf
        ...
        - 88F6323
                ...
                - 产品简介  : https://web.archive.org/web/20120616201639/http://www.marvell.com/embedded-processors/kirkwood/assets/88f632x_pb.pdf
  主页：
...
### Discovery 系列
  ...
  型号：
        - MV78100
                ...
                - 产品简介  : https://web.archive.org/web/20120616194711/http://www.marvell.com/embedded-processors/discovery-innovation/assets/MV78100-003_WEB.pdf
        ...
        - MV78200
                ...
                - 产品简介  : https://web.archive.org/web/20140801121623/http://www.marvell.com/embedded-processors/discovery-innovation/assets/MV78200-002_WEB.pdf
        ...
        - MV76100
                ...
                - 产品简介  : https://web.archive.org/web/20140722064429/http://www.marvell.com/embedded-processors/discovery-innovation/assets/MV76100-002_WEB.pdf
...
### EBU Armada 系列
 ...
 - 88F6720
    ...
    - 产品信息： https://web.archive.org/web/20140108032402/http://www.marvell.com/embedded-processors/armada-375/
 ...
 - 88F6928 Armada 398
    ...
    - 产品信息： https://web.archive.org/web/20181020222559/http://www.marvell.com/embedded-processors/armada-39x/
...
### PXA 2xx/3xx/93x/95x 系列
  ...
  型号：
        ...
        - PXA270, PXA271, PXA272
             - 产品简介         : https://web.archive.org/web/20150927135510/http://www.marvell.com/application-processors/pxa-family/assets/pxa_27x_pb.pdf
             ...
             - 开发者手册     : https://web.archive.org/web/20150927164805/http://www.marvell.com/application-processors/pxa-family/assets/pxa_27x_dev_man.pdf
        ...
        - PXA300, PXA310, PXA320
             - PXA 300 产品简介 : https://web.archive.org/web/20120111121203/http://www.marvell.com/application-processors/pxa-family/assets/PXA300_PB_R4.pdf
             - PXA 310 产品简介 : https://web.archive.org/web/20120111104515/http://www.marvell.com/application-processors/pxa-family/assets/PXA310_PB_R4.pdf
             - PXA 320 产品简介 : https://web.archive.org/web/20121021182826/http://www.marvell.com/application-processors/pxa-family/assets/PXA320_PB_R4.pdf
             ...
             - 开发者手册     : https://web.archive.org/web/20130727144605/http://www.marvell.com/application-processors/pxa-family/assets/PXA3xx_Developers_Manual.zip
             ...
             - 参考手册      : https://web.archive.org/web/20120111103844/http://www.marvell.com/application-processors/pxa-family/assets/PXA3xx_TavorP_BootROM_Ref_Manual.pdf
             - 仅应用处理器
   ...
   说明：
    ...
    - 这一系列 SoC 源自 Intel 开发的 XScale 系列，于 2006 年左右被 Marvell 收购。PXA21x、PXA25x、PXA26x、PXA27x、PXA3xx 与 PXA93x 由 Intel 开发，而后来的 PXA95x 由 Marvell 开发。

    - 由于其 XScale 渊源，这些 SoC 与 Marvell 的其他（Kirkwood、Dove 等）SoC 系列几乎毫无共同点，仅与 MMP/MMP2 系列 SoC 例外。
...
### MMP/MMP2/MMP3 系列（通信处理器）
  ...
  型号：
        - PXA168, a.k.a Armada 168
             ...
             - 产品简介        : https://web.archive.org/web/20111102030100/http://www.marvell.com/application-processors/armada-100/assets/pxa_168_pb.pdf
             ...
             - 应用节点包     : https://web.archive.org/web/20141005090706/http://www.marvell.com/application-processors/armada-100/assets/armada_16x_app_note_package.pdf
             - 仅应用处理器
        ...
        - PXA688, a.k.a. MMP2, a.k.a Armada 610 (OLPC XO-1.75)
             - 产品简介        : https://web.archive.org/web/20111102023255/http://www.marvell.com/application-processors/armada-600/assets/armada610_pb.pdf
             - 仅应用处理器
             - 内核：ARMv7 compatible Sheeva PJ4 88sv581x core
 - PXA2128, a.k.a. MMP3, a.k.a Armada 620 (OLPC XO-4)
      - 产品简介	    : https://web.archive.org/web/20120824055155/http://www.marvell.com/application-processors/armada/pxa2128/assets/Marvell-ARMADA-PXA2128-SoC-PB.pdf
      - 仅应用处理器
 ...
 - PXA1908/PXA1928/PXA1936
   ...
   说明：
    ...
    - 由于其 XScale 渊源，这些 SoC 与 Marvell 的其他（Kirkwood、Dove 等）SoC 系列几乎毫无共同点，仅与上文所列的 PXA 系列 SoC 例外。
...
### Berlin 系列（多媒体解决方案）
  ...
  - 型号：
 - 88DE3010, Armada 1000 (无 Linux 支持)
 ...
 - 88DE3218, ARMADA 1500 Ultra
  ...
  说明：
   ...
   - 这一系列 SoC 基于 Marvell Sheeva 或 ARM Cortex CPU，并采用 Synopsys DesignWare（IRQ、GPIO、Timers 等）与 PXA IP（SDHCI、USB、ETH 等）。

   - Berlin 系列于 2017 年由 Synaptics 从 Marvell 收购。

### CPU 内核


XScale 内核由 Intel 设计，并在较老的 PXA 处理器中由 Marvell 出货。Feroceon 是 Marvell 内部开发的专有内核，后来演进为 Sheeva。XScale 与 Feroceon 内核随时间被逐步淘汰，在后续产品中被 Sheeva 内核取代，随后又被获得授权的 ARM Cortex-A 内核取代。
...
### 长期计划
 ...
 - 将 mach-dove/、mach-mv78xx0/、mach-orion5x/ 统一到 mach-mvebu/ 中，以在单一的 mach-<foo> 目录下支持来自 Marvell EBU（Engineering Business Unit，工程业务单元）的全部 SoC。因此 plat-orion/ 将不复存在。
