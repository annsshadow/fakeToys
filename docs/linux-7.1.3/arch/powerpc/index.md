...
本页PowerPC 架构文档的索引，汇总该架构下的启动、CPU 特性、KVM、PCI 错误恢复、ISA 版本等各类参考文档入口，便于读者按主题快速定位相关说明
...
- [dexcr](dexcr)
- [dscr](dscr)
- [EEH PCI 错误恢复](eeh-pci-error-recovery)
