...
作为监视器容器，它会启用所有嵌套监视器并根据 OPTIONS 进行设置。不过，嵌套监视器也可以独立激活，既可以通过名称，也可以通过指定 sched:，例如要仅启用监视器 tss，你可以执行以下任一命令：
...
由 Gabriele Monaco <gmonaco@redhat.com> 编写
