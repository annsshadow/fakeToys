...
如果这些都没有出现，你应该在 BIOS 中查找诸如启ACPI / SMBus 甚至 USB
之类的设置
除最老的芯片（VT82C596A/B、VT82C686A，以及极可能VT8231）外，本驱动
支持 I2C 块事务。这类事务主要用于读EEPROM
CX700/VX800/VX820 似乎还支SMBus PEC，尽管本驱动尚未实现它