...
DAMON 是一Linux 内核子系统，用于高效的数据访问监
<damon_design_monitoring>` and :ref:`访问感知系统操作
<damon_design_damos>` 它的设计目的
...
如果您更喜欢学术论文阅读和引用，请使用论
浠?`HPDC'22 <https://dl.acm.org/doi/abs/10.1145/3502181.3531466>`_ 鍜。
`Middleware19 Industry <https://dl.acm.org/doi/abs/10.1145/3366626.3368125>`_ .
请注意，这些涵盖Linux v5.16 v5.15 中的 DAMON 实现
分别
