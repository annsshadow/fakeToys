...
Documentation/translations/zh_TW/process/license-rules.rst <tw_kernel_licensing>
...
以下是內核代碼中需要閱讀的文檔：
  ...
  Documentation/translations/zh_TW/process/coding-style.rst <tw_codingstyle>
  ...
  Documentation/translations/zh_TW/process/stable-api-nonsense.rst <tw_stable_api_nonsense>
  ...
  Documentation/translations/zh_TW/process/management-style.rst <tw_managementstyle>
...
內核源碼中的 Documentation/process/stable-kernel-rules.rst <stable_kernel_rules>
...
內核源碼主目錄中的admin-guide/reporting-bugs.rst <reportingbugs>
