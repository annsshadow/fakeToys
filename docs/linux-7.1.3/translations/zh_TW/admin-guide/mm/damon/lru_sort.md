...
DAMON對冷內存監測的採樣週期。更多細節請參考DAMON文檔 ([usage](usage)) 。默認5
毫秒。
...
DAMON對冷內存進行收集的時間週期。更多細節請參考DAMON文檔 ([usage](usage)) 。默認
100毫秒。
...
大會增加開銷。更多細節請參考DAMON文檔 ([usage](usage)) 。默認值爲10。
...
低會導致監測結果變差。更多細節請參考DAMON文檔 ([usage](usage)) 。默認值爲1000。
