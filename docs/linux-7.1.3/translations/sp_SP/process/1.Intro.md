...
sp_development_process introduce el proceso de desarrollo, el ciclo
...
sp_development_early_stage cubre la planificación de proyectos en
etapas tempranas, con énfasis en involucrar a la comunidad de desarrollo
lo antes posible.

sp_development_coding trata sobre el proceso de codificación. Se
...
sp_development_posting trata sobre el proceso de enviar parches para
...
sp_development_followthrough cubre lo que sucede después de publicar
...
sp_development_advancedtopics introduce un par de temas “avanzados”:
la administración de parches con git y la revisión de parches publicados
por otros.

sp_development_conclusion concluye el documento con punteros a las
