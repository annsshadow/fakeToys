...
El archivo Documentación/proceso/stable-kernel-rules.rst <stable_kernel_rules>
...
formato como se indica en Documentation/process/submitting-patches.rst <submittingpatches>.
