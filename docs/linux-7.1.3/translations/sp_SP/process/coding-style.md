...
kernel-doc. Consulte los archivos en Documentation/doc-guide/ <doc_guide>
...
Documentation/dev-tools/clang-format.rst <clangformat> para más
detalles.
...
process/coding-style.rst <codingstyle> del kernel, por greg@kroah.com at OLS 2002:
