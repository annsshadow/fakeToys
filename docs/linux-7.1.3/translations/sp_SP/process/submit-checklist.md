...
Documentation/translations/sp_SP/process/submitting-patches.rst <sp_submittingpatches>
...
5) Verifique su parche para el estilo general según se detalla en
   Documentation/translations/sp_SP/process/coding-style.rst <sp_codingstyle>.
