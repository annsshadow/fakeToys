...
and Documentation/translations/sp_SP/process/submit-checklist.rst <sp_submitchecklist>
...
que debe ocuparse:
 ...
 - ¿Está seguro de que su correo no corromperá los parches? Los parches
   ...
   Documentation/translations/sp_SP/process/email-clients.rst <sp_email_clients>
