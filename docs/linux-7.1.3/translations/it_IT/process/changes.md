...
**Per compilare il kernel vi servirà perl 5 e i seguenti moduli ``Getopt**
: Long``,
**``Getopt**
: Std`, `File::Basename`, e `File::Find``.
...
Per i dettaglio sui requisiti di Sphinx, fate riferimento a it_sphinx_install
in Documentation/translations/it_IT/doc-guide/sphinx.rst <it_sphinxdoc>
