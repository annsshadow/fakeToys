...
L'it_option_1 è **fortemente** raccomandata; è il modo più facile e
usato. L'it_option_2 si usa quando al momento della sottomissione non si
era pensato di riportare la modifica su versioni precedenti.
L'it_option_3 è un'alternativa ai due metodi precedenti quando la patch
