...
Documentation/translations/it_IT/dev-tools/clang-format.rst <it_clangformat>.
...
Documentation/translations/it_IT/core-api/memory-allocation.rst <it_memory_allocation>
