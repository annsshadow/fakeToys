...
:Original: Documentation/process/8.Conclusion.rst <development_conclusion>
...
Il file process/howto.rst <it_process_howto> è un punto di partenza
importante; process/submitting-patches.rst <it_submittingpatches> è
