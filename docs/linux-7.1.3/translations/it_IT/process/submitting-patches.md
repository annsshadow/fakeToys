...
Documentation/translations/it_IT/process/maintainer-handbooks.rst <it_maintainer_handbooks_main>
...
`git`, come un "commit log". Leggete it_the_canonical_patch_format.
...
divisa. Leggete it_split_changes.
...
it_the_canonical_patch_format). Aggiungete a CC tutte le persone che
...
patch. Per maggiori dettagli leggete it_describe_changes
