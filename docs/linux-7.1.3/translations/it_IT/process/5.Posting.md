...
:Original: Documentation/process/5.Posting.rst <development_posting>
...
translations/it_IT/process/submitting-patches.rst <it_submittingpatches>
e translations/it_IT/process/submit-checklist.rst <it_submitchecklist>.
...
Le etichette in uso più comuni sono:
 ...
 - Co-developed-by: indica che la patch è stata cosviluppata da diversi
   ...
   in Documentation/translations/it_IT/process/submitting-patches.rst <it_submittingpatches>.
...
dovreste aver cura:
 ...
 - Siete sicuri che il vostro programma di posta non corromperà le patch?
   ...
   Documentation/translations/it_IT/process/email-clients.rst <it_email_clients>
