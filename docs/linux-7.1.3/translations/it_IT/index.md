...
ufficiale è quella in lingua inglese: linux_doc

La propagazione simultanea a tutte le traduzioni di una modifica in
linux_doc è altamente improbabile. I manutentori delle traduzioni -
...
- [process/development-process](process/development-process)
- [process/submitting-patches](process/submitting-patches)
