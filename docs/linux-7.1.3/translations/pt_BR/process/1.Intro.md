...
development_process apresenta o processo de desenvolvimento, o ciclo de
...
development_early_stage cobre os primeiros passos do processo de
desenvolvimento, com ênfase no envolvimento da comunidade de desenvolvedores o
mais cedo possível.

development_coding é sobre o processo de codificação; muitas armadilhas
...
development_posting fala sobre o processo de envio de patches para
...
development_followthrough cobre o que acontece após o envio dos patches;
...
development_advancedtopics introduz dois tópicos mais "avançados":
gerenciamento de patches com git e revisão de patches por outros.

development_conclusion conclui o documento com indicações de fontes com
