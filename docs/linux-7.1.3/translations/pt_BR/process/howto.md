...
código-fonte estão descritas em Documentation/process/license-rules.rst <kernel_licensing>.
...
O arquivo Documentation/process/stable-kernel-rules.rst <stable_kernel_rules>
