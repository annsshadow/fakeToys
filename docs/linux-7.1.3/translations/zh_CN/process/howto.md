...
Documentation/translations/zh_CN/process/license-rules.rst <cn_kernel_licensing>
...
以下是内核代码中需要阅读的文档：
  ...
  Documentation/translations/zh_CN/process/coding-style.rst <cn_codingstyle>
  ...
  Documentation/translations/zh_CN/process/stable-api-nonsense.rst <cn_stable_api_nonsense>
  ...
  Documentation/translations/zh_CN/process/management-style.rst <cn_managementstyle>
...
内核源码中的 Documentation/process/stable-kernel-rules.rst <stable_kernel_rules>
...
内核源码主目录中的admin-guide/reporting-bugs.rst <reportingbugs>
