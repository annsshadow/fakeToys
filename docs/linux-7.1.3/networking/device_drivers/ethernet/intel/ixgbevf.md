...
## 面向 Intel(R) 10G 以太网 Linux 基础虚拟功能驱动


Intel 10 千兆虚拟功能 Linux 驱动。
...
该驱动支持基于 82599、X540、X550 和 X552 的虚拟功能设备，这些设备只能在支持 SR-IOV 的内核上激活。
...
VLAN：总共 64 个共享 VLAN 到 1 个或多个 VF 存在限制。
