...
## 引言
 ...
 的 Linux 驱动。该驱动支持 Chelsio N210 网卡，并
 向后兼容 Chelsio N110 型号的 10Gb 网卡。
...
## 性能
 ...
 更改这些系统参数，这取决于您的服务器/工作站
 应用。Chelsio Communications 不以任何方式保证
 这样做，并且风险由您自行承担。Chelsio 不会对
 数据丢失或设备损坏承担责任。

 您的发行版可能有不同的操作方式，或者您可能更喜欢
 其他方法。显示这些命令只是为了提供一个
 操作示例，绝非定论。
...
## 驱动信息
 ...
 以下是 syslog 记录的最常见信息。这些
 信息可以在 /var/log/messages 中找到。
...
## 已知问题
 ...
 这些问题是在测试期间发现的。以下信息
 作为该问题的临时解决办法提供。在某些情况下，此问题
 是 Linux 或特定 Linux 发行版和/或硬件平台
 所固有的。
...
## 支持
 ...
 联系我们的客户支持团队：support@chelsio.com，或访问我们的网站
...
它，遵循 GNU 通用公共许可证第 2 版（由
自由软件基金会发布）的条款。

您应该已经随本程序收到一份 GNU 通用公共许可证；
