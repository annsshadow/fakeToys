...
本页Linux 内核电源管理（PM）子系统的文档索引，汇总了挂起/休眠、运行时电源管理、能耗模型、OPP、稳压器与功耗上限等主题的参考文档入口。读者可据此按主题快速定位相关说明
...
- [apm-acpi](apm-acpi)
- [basic-pm-debugging](basic-pm-debugging)
...
- [功耗上功耗上限](powercap/powercap)
- [功耗上DTPM](powercap/dtpm)
- [绋冲帇鍣，娑堣垂鑰匽(regulator/consumer)
- [稳压设计](regulator/design)
- [稳压机器](regulator/machine)
