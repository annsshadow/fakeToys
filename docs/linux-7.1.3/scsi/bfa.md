...
## Linux 下 Brocade FC/FCOE 适配器驱动


### 支持的硬件


bfa 3.0.2.2 驱动支持所有 Brocade FC/FCOE 适配器。以下是各适配器型号及对应 PCIID 的列表。
	...
	1657:0021:103c:1779	804 8Gbps FC HBA（用于 HP Bladesystem c-class）
...
适用于 3.0.2.2 bfa 驱动的最新固件包可在以下位置找到：
...
然后点击相应的工具包链接：
	...
	版本		链接
	=========	=======================================================
	v3.0.0.0	适用于 RHEL 6.2、SLES 11SP2 的 Linux 适配器固件包
	=========	=======================================================
...
适用于 3.0.2.2 bfa 驱动的最新驱动配置与管理工具可在以下位置找到：
...
然后点击相应的工具包链接
	...
	版本		链接
	=========	=======================================================
	v3.0.2.0	适用于 RHEL 6.2、SLES 11SP2 的 Linux 适配器固件包
	=========	=======================================================
