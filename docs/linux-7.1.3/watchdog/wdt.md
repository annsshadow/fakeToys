...
ICS ISA 总线 wdt 卡无法被安全地探测。相反，你需```
...
其他 "wdt" 驱动参数如下
	===========	======================================================
	heartbeat	看门狗心跳间隔，单位秒（默认 60	nowayout	看门狗一旦启动便无法停止（内			编译参数	tachometer	WDT501-P 风扇转速计支持=禁用，默0	type		WDT501-P 卡类型（500 501，默500	===========	======================================================
