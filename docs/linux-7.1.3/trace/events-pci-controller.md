...
比照。 include/trace/events/pci_controller.h 用于事件定义。
...
# 监控事件（设备链接时会生成以下输出）
猫/系统/内核/调试/跟踪/trace_pipe
kworker/0:0-9 [^000^] ..... 5.600221: pcie_ltssm_state_transition: dev: a40000000.pcie 状态: RCVRY_EQ2 速率: 8.0 GT/s
