...
本文介绍 Nuvoton/Winbond W83795G 与 W83795ADG 硬件监控（hwmon）芯片的内核驱动支持情况，涵盖支持的芯片型号、I2C 地址、引脚映射与 Sysfs 属性，供传感器驱动适配与板级配置参考。
...
以下是 W83795G 和 W83795ADG 引脚映射的概要。这对于将板卡制造商提供的数据转换为可用的 libsensors
配置语句很有用。
