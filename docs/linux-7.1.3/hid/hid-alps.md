...
6	wReportDescRegister	0002	用于读取 Report 描述符的标识
8	wInputRegister		0003	用于读取 Input Report 的标识符
10	wMaxInputLength		0053	Input Report 80 字节 + 2
...
ReportID-3	(Input Reports)	   (厂商 Usage：最10 指数 用于 TP
ReportID-4	(Input Reports)	   (厂商 Usage：ON 位数 用于 GP
