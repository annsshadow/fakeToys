...
本页面列出受相应驱动支持的硬件设备卡，并给出各设备的名称USB 标识（USB ID），供用户对照硬件进行配置与排查
   ...
   - - dvbsky T680CI
     - 0572:680c
   - - MyGica 迷你 DVB-(T/T2/C) USB 接收T230
     - 0572:c688
   - - MyGica 迷你 DVB-(T/T2/C) USB 接收T230C
     - 0572:c689
   - - MyGica 迷你 DVB-(T/T2/C) USB 接收T230C Lite
     - 0572:c699
   - - MyGica 迷你 DVB-(T/T2/C) USB 接收T230C v2
     - 0572:c68a
