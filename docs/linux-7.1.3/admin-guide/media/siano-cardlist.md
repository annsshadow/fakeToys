...
本页面列出受相应驱动支持的硬件设备卡，并给出各设备的名称USB 标识（USB ID），供用户对照硬件进行配置与排查
   ...
   - - ONDA 鏁版嵁鍗，鏁板瓧鎺ユ敹鍣。
     - 19D2:0078
   - - Siano Denver (ATSC-M/H) 鏁板瓧鎺ユ敹鍣。
     - 187f:0800
   - - Siano Denver (TDMB) 鏁板瓧鎺ユ敹鍣。
     - 187f:0700
   - - Siano Ming 鏁板瓧鎺ユ敹鍣。
     - 187f:0310
   - - Siano Nice 鏁板瓧鎺ユ敹鍣。
     - 187f:0202, 187f:0202
   - - Siano Nova A 鏁板瓧鎺ユ敹鍣。
     - 187f:0200
   - - Siano Nova B 鏁板瓧鎺ユ敹鍣。
     - 187f:0201
   - - Siano Pele 鏁板瓧鎺ユ敹鍣。
     - 187f:0500
   - - Siano Rio 鏁板瓧鎺ユ敹鍣。
     - 187f:0600, 3275:0080
   - - Siano Stellar 鏁板瓧鎺ユ敹鍣。
     - 187f:0100
   - - Siano Stellar 鏁板瓧鎺ユ敹鍣?ROM
     - 187f:0010
   - - Siano Vega 鏁板瓧鎺ユ敹鍣。
     - 187f:0300
   - - Siano Venice 鏁板瓧鎺ユ敹鍣。
