...
本文件列出 CX88 系列视频卡驱动所支持的电视卡与视频采集卡型号清单，包含卡片编号、产品名称与 PCI 子系统 ID。供驱动适配与硬件识别时按型号或 PCI ID 核对设备，便于在移植与排错中定位具体硬件。
...
- - 24
- Hauppauge WinTV 28xxx (Roslyn) 型号
- 0070:2801

- - 25
- Digital-Logic MICROSPACE 娱乐中心 (MEC)
- 14f1:0342
...
- - 41
- Hauppauge WinTV-HVR1100 DVB-T/混合 (半高)
- 0070:9800, 0070:9802
