...
本文件列cx231xx 驱动所支持的硬件型号清单，包含厂商、产品名称与 USB ID，供驱动适配、硬件选型与设备排查时对照查阅
...
本页面列出受相应驱动支持的硬件设备卡，并给出各设备的名称USB 标识（USB ID），供用户对照硬件进行配置与排查
   ...
   - - 卡编
     ...
     - USB ID
   - - 0
     - Unknown cx231xx 视频采集
     - 0572:5A3C
   - - 1
     - Conexant 混合电视 - CARRAERA
     - 0572:58A2
   - - 2
     - Conexant 混合电视 - SHELBY
     - 0572:58A1
   - - 3
     - Conexant 混合电视 - RDE253S
     - 0572:58A4
   - - 4
     - Conexant 混合电视 - RDU253S
     - 0572:58A5
   - - 5
     - Conexant 视频采集
     - 0572:58A6, 07ca:c039
   - - 6
     - Conexant 混合电视 - rde 250
     - 0572:589E
   - - 7
     - Conexant 混合电视 - RDU 250
     - 0572:58A0
   - - 8
     - Hauppauge EXETER
     - 2040:b120, 2040:b140
