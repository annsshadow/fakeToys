...
本文件列EM28xx 系列 USB 视频采集设备（采集卡、电视棒、电视盒等）所支持的硬件型号清单，包含板卡编号、板卡名称、Empia 芯片型号USB 设备 ID，供驱动适配、硬件选型以及通过 card 模块参数指定具体设备时查阅


本表列出EM28xx 系列 USB 视频采集设备（视频采集卡、电视棒、电视盒等）的板卡编号、板卡名称、所使用Empia 芯片型号以及对应USB 设备 ID。其中“板卡编号”可用于内核模块参数 card 来指定具体设备；“Empia 芯片”为设备所用的 EM28xx 系列主芯片；“USB ID”的格式厂商ID:设备ID
...
:header-rows: 1
   ...
   - - 8
     ...
     -
   - - 9
     - Pinnacle Dazzle DVC 90/100/101/107 / Kaiser Baas 视频 to DVD maker / Kworld DVD 制作2 / Plextor ConvertX PX-AV100U
     - em2820 or em2840
   ...
   - - 20
     ...
     - 0438:b002
   - - 21
     - eMPIA Technology, Inc. GrabBeeX+ 视频编码
     - em2800
     - eb1a:2801
   - - 22
