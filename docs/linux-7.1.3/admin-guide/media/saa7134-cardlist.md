...
本页列出saa7134 系列视频捕获驱动支持的电视卡与采集卡设备，包含驱动模块、厂商与产品标识以及设备名称。设备名称中的描述性词汇已译为中文，品牌与型号标识符保留原文；表头已译为中文
...
## SAA7134 卡片列表
   ...
   - - 94
     - LifeView FlyDVB-T Hybrid Cardbus/MSI TV @nywhere 一D NB
   ...
   - - 140
     - Avermedia DVB-S 专业一00
     - 1461:一一

   - - 141
     - Avermedia DVB-S Hybrid+FM 一00
     - 1461:一一
   ...
   - - 149
     - Avermedia PCI pure analog (M135一
     - 1461:f11d
   ...
   - - 185
     - MagicPro ProHDTV 专业 DMB-TH/Hybrid
     - 17de:d136
   ...
   - - 192
     - AverMedia AverTV Satellite Hybrid+FM 一06
     - 1461:2055
