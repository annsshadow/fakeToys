...
本页面列出受相应驱动支持的硬件设备卡，并给出各设备的名称USB 标识（USB ID），供用户对照硬件进行配置与排查
   ...
   - - 网卡名称
     - USB ID
   - - AVerMedia AVerTV Volar 高清/专业(A835)
     - 07ca:a835, 07ca:b835
   ...
   - - PCTV microStick (79e)
     - 2013:0262
   - - Sveon STV22 DVB-T 高清电视
     - 1b80:e411
   - - Terratec Cinergy T 接收
     - 0ccd:0093
   - - Terratec Cinergy T 接收(修订. 2)
     - 0ccd:00aa
   - - Terratec Cinergy T 接收RC (修订. 2)
     - 0ccd:0099
   - - Terratec Cinergy TC2 接收
     - 0ccd:10b2
   - - Terratec T1
     - 0ccd:10ae
