...
本页是面向驱动开发者的内核 API 指南索引，汇总通用信息、支持库、总线级文档与各类子系统特定 API 的入口，便于按主题快速定位接口说明。



内核提供了种类繁多的接口，以支持设备驱动的开发。本文档只是其中部分接口
一个组织得并不十分完善的集合——希望随着时间的推移会变得更好！可用的小节
如下。
...
本节收录的文档，在某种程度上理应引起大多数从事设备驱动开发的开发者的
兴趣。
...
- [generic_pt](generic_pt)
- [gpio/index](gpio/index)
- [hsi](hsi)
- [hte/index](hte/index)
- [hw-recoverable-errors](hw-recoverable-errors)
- [i2c](i2c)
- [iio/index](iio/index)
