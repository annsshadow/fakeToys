...
- `POST /api/component/assemble/control/component/delete/all`
- `GET /api/component/assemble/control/status/list`
- `GET /api/component_assemble_control/create/component`
- `GET /api/component_assemble_control/delete/component`
- `GET /api/component_assemble_control/get/component`
- `GET /api/component_assemble_control/get/control/config`
- `GET /api/component_assemble_control/list/components`
- `GET /api/component_assemble_control/list/control/categories`
- `GET /api/component_assemble_control/save/component`
- `GET /api/component_assemble_control/update/control/config`
