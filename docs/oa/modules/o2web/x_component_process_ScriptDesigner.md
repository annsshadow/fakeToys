# x_component_process_ScriptDesigner
...
- `oa\o2web\source\x_component_process_ScriptDesigner\Main.js`
...
- 与后端 `ScriptVersionAction` 交互：在组件中调用 `ScriptVersionAction.get`、`listWithForm` 等方法完成 读取/列出 等操作。
