...
CMS（内容管理）前端组件，负责标题的界面展示与交互操作，通过 REST API 与后端模块通信。

## Entry Point

- `oa\o2web\source\x_component_cms_FormDesigner\Main.js`
...
- `$Main\bottom\tools-cms.json`: *To be described.*
...
- `$Main\default\tools-cms.json`: *To be described.*
