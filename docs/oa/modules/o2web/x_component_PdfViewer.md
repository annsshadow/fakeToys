...
- `oa\o2web\source\x_component_PdfViewer\Main.js`
...
- PDF 查看器组件，负责 PDF 文档的在线浏览和打印。（源码中未检出显式后端 action 调用，主要在前端完成交互与渲染。）
- 核心交互：PDF 查看器组件，负责 PDF 文档的在线浏览和打印。
- 核心交互：PDF 查看器组件，负责 PDF 文档的在线浏览和打印。
