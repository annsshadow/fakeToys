...
def generate_markdown(modules, dependencies, scores, output_path):
    ...
    output.append('  - 包含端点：/api/authentication/*（login, logout, who, captcha, code, bind, oauth 等）')
    output.append('')
    ...
    output.append('  - 包含端点：/api/person/*、/api/unit/*、/api/role/*、/api/group/* 等')
    output.append('')
    ...
    output.append('- **关键端点：** /api/authentication/login, /api/authentication/logout, /api/authentication/who, /api/authentication/captcha, /api/authentication/code, /api/authentication/bind, /api/authentication/oauth')
    output.append('')
    ...
    output.append('- **关键端点：** /api/person/*, /api/unit/*, /api/role/*, /api/group/*')
    output.append('')
    output.append('### x_program_init（系统初始化，含 /api/secret/*）')
    output.append('')
    ...
    output.append('- **关键端点：** /api/secret/check, /api/secret/set, /api/secret/cancel')
    output.append('')
    output.append('---')
    output.append('')
