...
全局口径 **4095/4638 = 88.4%**（全仓去 mock 真注册路由 4638；桶外 off-metric 真注册 570 条，余 20 条凭证/SSO/企业微信/WeLink/重置/密钥族记档不接）。
...
在获明确授权前剩余 523 条桶内维持不接，**87.2%（桶）/88.4%（全局）为当前守得住的诚实终态**（rev487 收尾补 market install-or-update 1 条，37 条 arity-OK 残余全属二进制/回调/凭证/验证码/外部同步 skip 类）。
