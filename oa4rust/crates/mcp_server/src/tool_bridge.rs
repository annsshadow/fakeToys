...
/// The tool name follows the convention `{crate}_{action}`.
static ROUTE_DEFS: &[RouteDef] = &[
    ...
    register_tool! {
        name: "authentication_who",
        method: Get,
        path: "/api/authentication/who",
        desc: "Return current session user info",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "authentication_captcha",
        method: Get,
        path: "/api/authentication/captcha",
        desc: "Generate captcha image",
        path_params: [],
        body_params: ["width", "height"],
    },
    register_tool! {
        name: "authentication_captcha_dimensions",
        method: Get,
        path: "/api/authentication/captcha/width/{width}/height/{height}",
    ...
    register_tool! {
        ...
        method: Post,
        path: "/api/authentication/code",
        desc: "Send verification code",
        path_params: [],
        body_params: ["credential"],
    },
    register_tool! {
        name: "authentication_code_credential",
        method: Get,
        path: "/api/authentication/code/credential/{credential}",
        desc: "Check verification code status for credential",
        path_params: ["credential"],
        body_params: [],
    },
    register_tool! {
        name: "authentication_bind",
        method: Post,
        path: "/api/authentication/bind",
        desc: "Bind account to third-party",
        path_params: [],
        body_params: ["meta", "code"],
    },
    register_tool! {
        name: "authentication_bind_meta",
        method: Get,
        path: "/api/authentication/bind/meta/{meta}",
    ...
    register_tool! {
        name: "authentication_oauth_list",
        method: Get,
        path: "/api/authentication/oauth/list",
        desc: "List configured OAuth providers",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "authentication_oauth_qywx_config",
        method: Get,
        path: "/api/authentication/oauth/qywx/config",
        desc: "Get WeCom OAuth config",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "authentication_oauth_dingding_config",
        method: Get,
    ...
    register_tool! {
        name: "authentication_oauth_name",
        method: Get,
        path: "/api/authentication/oauth/name/{name}",
        desc: "Get OAuth provider config by name",
        path_params: ["name"],
        body_params: [],
    },
    register_tool! {
        name: "authentication_oauth_login_qywx",
        method: Get,
    ...
    register_tool! {
        name: "authentication_oauth_login_dingding",
        method: Get,
        path: "/api/authentication/oauth/login/dingding/code/{code}",
        desc: "OAuth login via DingTalk authorization code",
        path_params: ["code"],
        body_params: [],
    },
    register_tool! {
        name: "authentication_oauth_login_name",
        method: Get,
        path: "/api/authentication/oauth/login/name/{name}/code/{code}/redirecturi/{redirectUri}",
        desc: "OAuth login with redirect URI",
        path_params: ["name", "code", "redirectUri"],
        body_params: [],
    },
    register_tool! {
        name: "authentication_oauth_bind_name",
        method: Get,
        path: "/api/authentication/oauth/bind/name/{name}/code/{code}/redirecturi/{redirectUri}",
    ...
    register_tool! {
        name: "secret_captcha_verify",
        method: Post,
        path: "/api/secret/captcha/verify",
    ...
    register_tool! {
        name: "person_icon",
        method: Post,
        path: "/api/person/{id}/icon",
        desc: "Upload person avatar icon",
        path_params: ["id"],
        body_params: ["icon"],
    },
    register_tool! {
        name: "reset_password_anonymous",
        method: Post,
        path: "/api/reset/password/anonymous",
    ...
    // ── control ─────────────────────────────────────────────────────────────
    register_tool! {
        name: "control_unit_list",
        method: Get,
        path: "/api/control/unit/list",
    ...
    // ── express ─────────────────────────────────────────────────────────────
    register_tool! {
        name: "express_module_list",
        method: Get,
        path: "/api/express/module/list",
    ...
    // ── message ─────────────────────────────────────────────────────────────
    register_tool! {
        name: "message_inbox_list",
        method: Get,
        path: "/api/message/inbox/list",
    ...
    register_tool! {
        name: "bbs_topic_list",
        method: Get,
        path: "/api/bbs/topic/list",
        desc: "List BBS topics",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "bbs_topic_create",
        method: Post,
        path: "/api/bbs/topic",
    ...
    register_tool! {
        name: "bbs_post_list",
        method: Get,
        path: "/api/bbs/post/list",
        desc: "List BBS posts",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "bbs_post_create",
        method: Post,
        path: "/api/bbs/post",
    ...
    // ── attendance ──────────────────────────────────────────────────────────
    register_tool! {
        name: "attendance_record_list",
        method: Get,
        path: "/api/attendance/record/list",
        desc: "List attendance records",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "attendance_record_create",
        method: Post,
    ...
    // ── correlation ─────────────────────────────────────────────────────────
    register_tool! {
        name: "correlation_link_list",
        method: Get,
        path: "/api/correlation/link/list",
        desc: "List correlation links",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "correlation_link_create",
        method: Post,
        path: "/api/correlation/link",
    ...
    register_tool! {
        ...
        method: Get,
        path: "/api/general/config/list",
        desc: "List general configurations",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "general_config_get",
        method: Get,
        path: "/api/general/config/{key}",
    ...
    register_tool! {
        name: "meeting_openmeeting_list_room",
        method: Get,
    ...
    // ── process_express ─────────────────────────────────────────────────────
    register_tool! {
        name: "process_instance_list",
        method: Get,
        path: "/api/process/instance/list",
        desc: "List process instances",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "process_instance_start",
        method: Post,
        path: "/api/process/instance/start",
    ...
    // ── process_designer ────────────────────────────────────────────────────
    register_tool! {
        name: "process_design_list",
        method: Get,
        path: "/api/process/design/list",
    ...
    // ── process_bam ─────────────────────────────────────────────────────────
    register_tool! {
        name: "process_bam_monitor",
        method: Get,
        path: "/api/process/bam/monitor",
    ...
    // ── process_surface ─────────────────────────────────────────────────────
    register_tool! {
        name: "process_surface_task_list",
        method: Get,
        path: "/api/process/surface/task/list",
    ...
    register_tool! {
        name: "file_assemble_detail",
        method: Get,
        path: "/api/file/assemble/detail/{id}",
    ...
    // ── ai_assemble_control ─────────────────────────────────────────────────
    register_tool! {
        name: "ai_assemble_config",
        method: Get,
        path: "/api/ai/assemble/config",
    ...
    register_tool! {
        name: "hotpic_assemble_list",
        method: Get,
        path: "/api/hotpic/assemble/list",
    ...
    register_tool! {
        name: "organization_assemble_list",
        method: Get,
        path: "/api/organization/assemble/list",
        desc: "List organization assemble data",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "organization_assemble_person_list",
        method: Get,
        path: "/api/organization/assemble/person/list",
    ...
    register_tool! {
        name: "organization_assemble_unit_tree",
        method: Get,
        path: "/api/organization/assemble/unit/tree",
    ...
    register_tool! {
        name: "mind_assemble_list",
        method: Get,
        path: "/api/mind/assemble/list",
    ...
    register_tool! {
        name: "attendance_assemble_daily",
        method: Get,
        path: "/api/attendance/assemble/daily",
    ...
    register_tool! {
        name: "general_assemble_config",
        method: Get,
        path: "/api/general/assemble/config",
    ...
    register_tool! {
        name: "message_assemble_send",
        method: Post,
        path: "/api/message/assemble/send",
    ...
    register_tool! {
        name: "portal_assemble_page_list",
        method: Get,
        path: "/api/portal/assemble/page/list",
    ...
    register_tool! {
        name: "correlation_service_process",
        method: Post,
        path: "/api/correlation/service/process",
    ...
    register_tool! {
        name: "portal_assemble_surface_widgets",
        method: Get,
        path: "/api/portal/assemble/surface/widgets",
    ...
    register_tool! {
        name: "processplatform_service_task_list",
        method: Get,
        path: "/api/processplatform/service/task/list",
    ...
    register_tool! {
        name: "bbs_assemble_topic_list",
        method: Get,
        path: "/api/bbs/assemble/topic/list",
    ...
    register_tool! {
        name: "calendar_assemble_event_list",
        method: Get,
        path: "/api/calendar/assemble/event/list",
    ...
    register_tool! {
        name: "component_assemble_list",
        method: Get,
        path: "/api/component/assemble/list",
    ...
    register_tool! {
        name: "jpush_assemble_send",
        method: Post,
        path: "/api/jpush/assemble/send",
    ...
    register_tool! {
        name: "processplatform_core_definition_list",
        method: Get,
        path: "/api/processplatform/core/definition/list",
    ...
    // ── portal_core_entity ──────────────────────────────────────────────────
    register_tool! {
        name: "portal_core_page_list",
        method: Get,
        path: "/api/portal/core/page/list",
    ...
    register_tool! {
        name: "program_center_core_list",
        method: Get,
        path: "/api/program_center/core/list",
    ...
    register_tool! {
        name: "processplatform_core_express_task_list",
        method: Get,
        path: "/api/processplatform/core/express/task/list",
    ...
    // ── query_core_entity ───────────────────────────────────────────────────
    register_tool! {
        name: "query_core_list",
        method: Get,
        path: "/api/query/core/list",
    ...
    // ── general_core_entity ─────────────────────────────────────────────────
    register_tool! {
        name: "general_core_list",
        method: Get,
        path: "/api/general/core/list",
    ...
    register_tool! {
        name: "organization_core_unit_list",
        method: Get,
        path: "/api/organization/core/unit/list",
    ...
    // ── cms_core_entity ─────────────────────────────────────────────────────
    register_tool! {
        name: "cms_core_article_list",
        method: Get,
        path: "/api/cms/core/article/list",
    ...
    register_tool! {
        name: "query_assemble_designer_list",
        method: Get,
    ...
    register_tool! {
        name: "query_assemble_surface_list",
        method: Get,
        path: "/api/query/assemble/surface/list",
    ...
    register_tool! {
        name: "processplatform_assemble_surface_task_list",
        method: Get,
        path: "/api/processplatform/assemble/surface/task/list",
    ...
    // ── bbs_core_entity ─────────────────────────────────────────────────────
    register_tool! {
        name: "bbs_core_topic_list",
        method: Get,
        path: "/api/bbs/core/topic/list",
    ...
    register_tool! {
        name: "calendar_core_event_list",
        method: Get,
        path: "/api/calendar/core/event/list",
    ...
    register_tool! {
        name: "component_core_list",
        method: Get,
        path: "/api/component/core/list",
    ...
    register_tool! {
        name: "attendance_core_list",
        method: Get,
        path: "/api/attendance/core/list",
    ...
    // ── cms_core_express ────────────────────────────────────────────────────
    register_tool! {
        name: "cms_core_express_article_list",
        method: Get,
        path: "/api/cms/core/express/article/list",
    ...
    register_tool! {
        name: "correlation_core_link_list",
        method: Get,
        path: "/api/correlation/core/link/list",
    ...
    register_tool! {
        name: "correlation_core_express_list",
        method: Get,
        path: "/api/correlation/core/express/list",
    ...
    // ── hotpic_core_entity ──────────────────────────────────────────────────
    register_tool! {
        name: "hotpic_core_list",
        method: Get,
        path: "/api/hotpic/core/list",
    ...
    // ── jpush_core_entity ───────────────────────────────────────────────────
    register_tool! {
        name: "jpush_core_list",
        method: Get,
        path: "/api/jpush/core/list",
    ...
    // ── meeting_core_entity ─────────────────────────────────────────────────
    register_tool! {
        name: "meeting_core_list",
        method: Get,
        path: "/api/meeting/core/list",
    ...
    // ── message_core_entity ─────────────────────────────────────────────────
    register_tool! {
        name: "message_core_list",
        method: Get,
        path: "/api/message/core/list",
    ...
    register_tool! {
        name: "organization_core_express_list",
        method: Get,
        path: "/api/organization/core/express/list",
    ...
    register_tool! {
        name: "processplatform_assemble_bam_list",
        method: Get,
        path: "/api/processplatform/assemble/bam/list",
    ...
    register_tool! {
        name: "processplatform_assemble_designer_list",
        method: Get,
        path: "/api/processplatform/assemble/designer/list",
    ...
    // ── query_core_express ──────────────────────────────────────────────────
    register_tool! {
        name: "query_core_express_list",
        method: Get,
        path: "/api/query/core/express/list",
    ...
    register_tool! {
        name: "query_service_process",
        method: Post,
        path: "/api/query/service/process",
    ...
    register_tool! {
        name: "reset_code_credential",
        method: Post,
        path: "/api/reset/code/credential/{credential}",
    ...
    register_tool! {
        name: "authentication_two_factor",
        method: Post,
        path: "/api/authentication/two_factor",
        desc: "Two-factor authentication login",
        path_params: [],
        body_params: ["credential", "code"],
    },
    register_tool! {
        name: "authentication_safe_logout",
        method: Post,
        path: "/api/authentication/safe/logout",
        desc: "Securely logout and revoke all sessions",
        path_params: [],
        body_params: [],
    },
    register_tool! {
        name: "authentication_check_token",
        method: Post,
        path: "/api/authentication/check/token",
        desc: "Check token validity",
        path_params: [],
        body_params: ["token"],
    },
    register_tool! {
        name: "authentication_sso_encrypt",
        method: Post,
        path: "/api/authentication/sso/encrypt",
        desc: "Encrypt SSO token for single sign-on",
        path_params: [],
        body_params: ["client", "key", "credential"],
    },
    register_tool! {
        name: "authentication_sso",
        method: Post,
        path: "/api/authentication/sso",
        desc: "SSO login via token",
        path_params: [],
        body_params: ["client", "token"],
    },
    register_tool! {
        name: "authentication_switchuser",
        method: Post,
        path: "/api/authentication/switchuser",
