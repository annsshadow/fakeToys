...
mod tests {
    ...
    async fn test_get_designer() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/query/assemble/designer/get/test-id")
                    .method("GET")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_list_designers() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/query/assemble/designer/list/test-id")
                    .method("GET")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_save_designer() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/query/assemble/designer/save/test-id")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_delete_designer() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/query/assemble/designer/delete/test-id")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
