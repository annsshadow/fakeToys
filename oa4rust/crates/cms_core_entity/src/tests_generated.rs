...
mod tests {
    ...
    async fn test_category_list() {
        ...
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "category_list route should be registered");
    }

    #[tokio::test]
    async fn test_category_get() {
        let pool = shared::testing::test_pool();
        let app = crate::router(pool);
        let response = app
            .oneshot(
            ...
            .unwrap();
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "category_get route should be registered");
    }
    ...
    async fn test_category_create() {
        ...
        let response = app
            ...
            .unwrap();
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "category_create route should be registered");
    }
    ...
    async fn test_article_list() {
        ...
        let response = app
            ...
            .unwrap();
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "article_list route should be registered");
    }
    ...
    async fn test_article_get() {
        ...
        let response = app
            ...
            .unwrap();
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "article_get route should be registered");
    }
    ...
    async fn test_article_create() {
        ...
        let response = app
            ...
            .unwrap();
        assert_ne!(response.status(), StatusCode::NOT_FOUND,
            "article_create route should be registered");
    }
