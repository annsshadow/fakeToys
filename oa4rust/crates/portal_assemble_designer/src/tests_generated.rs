...
mod tests {
    ...
    async fn test_get_design() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/get/test-id")
                    .method("GET")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_save_design() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/save/test-id")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_list_pages_by_category() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/page/list/test-id")
                    .method("GET")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_get_page() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/page/test-id")
                    .method("GET")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_create_page() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/page/create")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_save_page() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/page/save/test-id")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
    ...
    async fn test_delete_page() {
        ...
        let response = app
            .oneshot(
                Request::builder()
                    .uri("/api/portal/assemble/designer/page/delete/test-id")
                    .method("POST")
                    .body(Body::empty())
                    .unwrap(),
            )
