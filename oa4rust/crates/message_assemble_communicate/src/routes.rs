...
pub fn router(pool: Pool) -> Router {
    Router::new()
        ...
        .route("/jaxrs/message/assemble/communicate/consume/type/{type}", get(consume_type_type).put(consume_type_type_mockputtopost))
        .route("/jaxrs/message/assemble/communicate/consume/type/{type}/mockputtopost", post(consume_type_type_mockputtopost))
        .route("/jaxrs/message/assemble/communicate/consume/{id}/type/{type}", post(consume_id_type_type).get(consume_id_type_type))
        // im conversation
...
.route("/jaxrs/message/assemble/communicate/im/conversation", put(im_conversation))
        ...
        .route("/jaxrs/message/assemble/communicate/im/conversation/list/with/person", get(im_conversation_list_with_person).post(im_conversation_list_with_person))
...
.route("/jaxrs/message/assemble/communicate/im/conversation/{id}/group", delete(im_conversation_id_group))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/group/mockdeletetoget", delete(im_conversation_id_group_mockdeletetoget).get(im_conversation_id_group_mockdeletetoget))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/group/quit/self", post(im_conversation_id_group_quit_self).get(im_conversation_id_group_quit_self))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/icon", get(im_conversation_id_icon))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/read", post(im_conversation_id_read).put(im_conversation_id_read))
        ...
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/single", get(im_conversation_id_single).delete(im_conversation_id_single_delete_virtual))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/single/mockdeletetoget", delete(im_conversation_id_single_delete_virtual).get(im_conversation_id_single_delete_virtual))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/top/cancel", post(im_conversation_id_top_cancel).put(im_conversation_id_top_cancel))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/top/cancel/mockputtopost", post(im_conversation_id_top_cancel_mockputtopost).put(im_conversation_id_top_cancel_mockputtopost))
        .route("/jaxrs/message/assemble/communicate/im/conversation/{id}/top/set", post(im_conversation_id_top_set).put(im_conversation_id_top_set))
        ...
        .route("/jaxrs/message/assemble/communicate/im/msg/collection/list/{page}/size/{size}", get(im_msg_collection_list_page_size_size).post(im_msg_collection_list_page_size_size))
        .route("/jaxrs/message/assemble/communicate/im/msg/collection/remove", post(im_msg_collection_remove).delete(im_msg_collection_remove))
        ...
        .route("/jaxrs/message/assemble/communicate/im/msg/list/object", get(im_msg_list_object).post(im_msg_list_object))
        .route("/jaxrs/message/assemble/communicate/im/msg/list/{page}/size/{size}", get(im_msg_list_page_size_size).post(im_msg_list_page_size_size))
        .route("/jaxrs/message/assemble/communicate/im/msg/revoke/{id}", post(im_msg_revoke_id).get(im_msg_revoke_id))
        ...
        .route("/jaxrs/message/assemble/communicate/instant/currentperson/consumed", get(instant_currentperson_consumed).put(instant_currentperson_consumed_put))
        ...
        .route("/jaxrs/message/assemble/communicate/mass/enable/type", post(mass_enable_type).get(mass_enable_type_get))
        ...
        .route("/jaxrs/message/assemble/communicate/mass/{id}", get(mass_id).delete(mass_id_mockdeletetoget))
        .route("/jaxrs/message/assemble/communicate/mass/{id}/mockdeletetoget", delete(mass_id_mockdeletetoget).get(mass_id_mockdeletetoget))
        // message
        .route("/jaxrs/message/assemble/communicate/message/custom/create", post(message_custom_create))
        .route("/jaxrs/message/assemble/communicate/message/list/paging/{page}/size/{size}", get(message_list_paging_page_size_size).post(message_list_paging_page_size_size))
