...
use crate::{
    endpoints::{
        identity_list, identity_list_object, identity_list_person, identity_list_unit_sub_direct,
        identity_list_unit_sub_nested, person_auth_info_flag, person_has_role, person_list,
        person_list_all, person_list_all_object, person_list_filter_page_size, person_list_group,
        person_list_identity, person_list_object, person_list_role, person_mobile_flag,
        person_nick_name_flag,
    },
    endpoints_attr::{
    ...
    endpoints_org2::{
        ...
        identity_list_major_person_object, identity_list_person_object, identity_list_unit_person,
        identity_list_unit_person_object, identity_list_unit_sub_direct_object,
        identity_list_unit_sub_nested_object,
    },
    endpoints_person2::{
        ...
        person_list_login_recent_object, person_list_pair_identity, person_list_person_sub_direct,
        person_list_person_sub_direct_object, person_list_person_sub_nested,
        person_list_person_sub_nested_object, person_list_person_sup_direct,
        person_list_person_sup_direct_object, person_list_person_sup_nested,
        person_list_person_sup_nested_object, person_list_personattribute,
        person_list_personattribute_object, person_list_role_object, person_list_unit_sub_direct,
        person_list_unit_sub_direct_like, person_list_unit_sub_direct_like_object,
        person_list_unit_sub_direct_object, person_list_unit_sub_nested,
        person_list_unit_sub_nested_like, person_list_unit_sub_nested_like_object,
