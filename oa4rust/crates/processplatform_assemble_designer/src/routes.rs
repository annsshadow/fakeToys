...
pub fn router(pool: Pool) -> Router {
    Router::new()
        ...
        .route("/jaxrs/processplatform/assemble/designer/script/{id}", get(crate::script_id).put(crate::u2_script::update).delete(crate::u2_script::delete))
        .route("/jaxrs/processplatform/assemble/designer/script", post(crate::u2_script::create))
