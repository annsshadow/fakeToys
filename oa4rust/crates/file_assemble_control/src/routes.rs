...
pub fn router(pool: Pool) -> Router {
    Router::new()
        ...
        .route("/jaxrs/file/clean/unused/referencetype/cmsdocument/manage", get(file_clean_unused_referencetype_cmsdocument_manage))
        .route("/jaxrs/file/copy/attachment/attachmentId/referencetype/referenceType/reference/reference/scale/scale", get(file_copy_attachment_attachmentId_referencetype_referenceType_reference_reference_scale_scale))
        .route("/jaxrs/file/list/referencetype", get(file_list_referencetype))
        .route("/jaxrs/file/list/referencetype/referenceType/reference/reference", get(file_list_referencetype_referenceType_reference_reference))
        .route("/jaxrs/file/list/unused/referencetype/cmsdocument/manage", get(file_list_unused_referencetype_cmsdocument_manage))
        .route("/jaxrs/file/list/id/next/count", get(file_list_id_next_count))
        .route("/jaxrs/file/list/id/next/count/all", get(file_list_id_next_count_all))
        .route("/jaxrs/file/list/id/next/count/referencetype/referenceType", get(file_list_id_next_count_referencetype_referenceType))
        .route("/jaxrs/file/list/id/prev/count", get(file_list_id_prev_count))
        .route("/jaxrs/file/list/id/prev/count/all", get(file_list_id_prev_count_all))
        .route("/jaxrs/file/list/id/prev/count/referencetype/referenceType", get(file_list_id_prev_count_referencetype_referenceType))
        .route("/jaxrs/file/referencetype/referenceType/reference/reference", get(file_referencetype_referenceType_reference_reference))
        .route("/jaxrs/file/id", get(file_id))
        .route("/jaxrs/file/id/binary/base64", get(file_id_binary_base64))
