...
pub fn router(pool: Pool) -> Router {
    Router::new()
        ...
        .route("/jaxrs/bbs/assemble/control/shutup/delete", post(shutup_delete))
        ...
        .route("/jaxrs/bbs/assemble/control/delete/forum", delete(crate::delete_forum))
        .route("/jaxrs/bbs/assemble/control/delete/reply", post(crate::delete_reply))
        .route("/jaxrs/bbs/assemble/control/delete/reply", delete(crate::delete_reply))
        .route("/jaxrs/bbs/assemble/control/delete/subject", post(crate::delete_subject))
        .route("/jaxrs/bbs/assemble/control/delete/subject", delete(crate::delete_subject))
        ...
        .route(&fmt("subjectattach/{id}"), delete(u2::u2_subjectattach_delete))
