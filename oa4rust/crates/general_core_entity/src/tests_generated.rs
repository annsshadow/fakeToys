...
mod tests {
    ...
    #[tokio::test]
    async fn test_dict_item_create() {
        let pool = shared::testing::test_pool();
        let app = crate::router(pool);
        let response = app
            .oneshot(
    ...
    #[tokio::test]
    async fn test_dict_item_update() {
        let pool = shared::testing::test_pool();
        let app = crate::router(pool);
        let response = app
            .oneshot(
    ...
    #[tokio::test]
    async fn test_dict_item_delete() {
        let pool = shared::testing::test_pool();
        let app = crate::router(pool);
        let response = app
            .oneshot(
