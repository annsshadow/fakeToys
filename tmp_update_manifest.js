...
const defs = {
  'CmsDictDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/cms/assemble/control/dict/create"']],
  ...
  'CmsFormDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/cms/assemble/control/form/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'CmsViewDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/cms/assemble/control/view/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'CmsXformApp.vue': {
    acc: 'CMS XForm 定义数据驱动 CRUD：list/create/save/delete 实挂 x_cms_form（name/app_id/definition JSON 编辑、参数化写、软删、删除需确认）',
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/cms/assemble/control/xform/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'TemplateApp.vue': {
    acc: '模板数据驱动 CRUD：list/create/save/delete 实挂 x_cms_form_v2（name/app_id/definition JSON、参数化写、软删、删除需确认）',
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/templateform/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'LogViewerApp.vue': {
    acc: '日志只读查看：GET /api/log/list 实挂 x_cms_log（app_id/operation_type/operation_level/person_id/ip_address/operation_detail 检索展示；日志家族无写语义，不声明写能力）',
    be: [['oa4rust/crates/cms_assemble_control/src/routes.rs', '"/api/log/list"']],
    fe2: 'api.get(listEp)',
  },
  'PortalDictDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/portal_assemble_designer/src/lib.rs', '"/api/portal/assemble/designer/dict/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'PortalPageDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/portal_assemble_designer/src/lib.rs', '"/api/portal/assemble/designer/page/create"']],
  ...
  'PortalWidgetDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/portal_assemble_designer/src/lib.rs', '"/api/portal/assemble/designer/widget/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'ProcessDictDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/processplatform_assemble_designer/src/routes.rs', '"/api/processplatform/assemble/designer/dict/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'ProcessFormDesignerApp.vue': {
    acc: '流程表单数据驱动 CRUD：list/create/save/delete 实挂 pp_e_form（name/application 类型化字段、参数化写、软删、删除需确认）',
    be: [['oa4rust/crates/processplatform_assemble_designer/src/routes.rs', '"/api/processplatform/assemble/designer/form/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'ProcessXformApp.vue': {
    acc: '流程 XForm 数据驱动 CRUD：list/create/save/delete 实挂迁移 097 x_pp_xform（name/flag/desc 类型化字段、参数化写、软删、删除需确认）',
    be: [
      ['oa4rust/crates/processplatform_assemble_designer/src/routes.rs', '"/api/processplatform/assemble/designer/xform/create"'],
  ...
  'ProcessManagerApp.vue': {
    ...
    be: [['oa4rust/crates/processplatform_assemble_surface/src/routes.rs', '"/api/processplatform/assemble/surface/process_manager/list"']],
    fe2: 'api.get(listEp)',
  },
  'ProcessTaskCenterApp.vue': {
    ...
    be: [['oa4rust/crates/processplatform_service_processing/src/routes.rs', '"/api/processplatform/service/processing/task/list"']],
    fe2: 'api.post(`/api/processplatform/service/processing/task/processing/`',
  },
  'QueryExplorerApp.vue': {
    acc: '查询视图只读浏览：GET explorer/list 实挂 x_query_view（name/queryType 检索展示；视图写入口在设计器家族，不在此声明写能力）',
    be: [['oa4rust/crates/query_assemble_surface/src/lib.rs', '"/api/query/assemble/surface/explorer/list"']],
    fe2: 'api.get(listEp)',
  },
  'QueryImporterDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/query_assemble_designer/src/lib.rs', '"/api/query/assemble/designer/importer/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'QueryStatDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/query_assemble_designer/src/lib.rs', '"/api/query/assemble/designer/stat/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'ThreeMemberApp.vue': {
    acc: '三方成员数据驱动 CRUD：list/create/save/delete 实挂 x_org_person（name/mobile/email/unitId/status 类型化字段、参数化写、软删、删除需确认）',
    be: [['oa4rust/crates/organization_assemble_control/src/u2_router.rs', '"/api/organization/assemble/control/threemember/create"']],
    fe2: 'api.post(createEp, payload)',
  },
  'ServiceInvokeDesignerApp.vue': {
    ...
    be: [['oa4rust/crates/program_center/src/routes.rs', '"/api/program_center/invoke/create"']],
    fe2: 'api.post(createEp, payload)',
  },
};
const viewToListEp = {
