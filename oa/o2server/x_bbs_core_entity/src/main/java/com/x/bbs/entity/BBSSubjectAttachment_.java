...
public class BBSSubjectAttachment_ extends StorageObject_  {
    ...
    public static volatile SingularAttribute<BBSSubjectAttachment,Boolean> deepPath;
    ...
    public static volatile SingularAttribute<BBSSubjectAttachment,String> nickName;
