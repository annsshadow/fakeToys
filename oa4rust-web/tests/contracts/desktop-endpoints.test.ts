...
const KNOWN_BACKEND_GAPS: string[] = [
  ...
  '/jaxrs/ai_assemble_control/',
  '/jaxrs/attendance/assemble/control/',
  '/jaxrs/attendance/assemble/control/export',
  '/jaxrs/attendance/assemble/control/rule/',
  ...
  '/jaxrs/processplatform/assemble/bam/',
