<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>门户脚本设计器</h1>
        <p class="subtitle">/jaxrs/portal/assemble/designer/script/list</p>
      </div>
...
const ep = '/jaxrs/portal/assemble/designer/script/list';
const qk = ['portal_ScriptDesigner', 'list'];
