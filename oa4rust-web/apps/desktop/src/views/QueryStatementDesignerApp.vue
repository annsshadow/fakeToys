<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>SQL设计器</h1>
        <p class="subtitle">/jaxrs/query/assemble/designer/statement/list</p>
      </div>
...
const ep = '/jaxrs/query/assemble/designer/statement/list';
const qk = ['query_StatementDesigner', 'list'];
