...
const cms_core_article_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/core/article/list')
...
const cms_view_publish_view_001_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/view/publish/view-001')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_cmsview_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsview/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_assemble_control_cmscategory_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmscategory')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_cmsdocument_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsdocument/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_assemble_control_cmsview_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsview')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_view_list_all_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/view/list/all')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_cmsdocumentcategory_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsdocumentcategory/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_uuid_random_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/uuid/random')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_cmscategory_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmscategory/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_templateform_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/templateform/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_article_test_article_id_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/article/test-article-id')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_cmsapplication_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsapplication/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_category_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/category/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_category_test_category_id_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/category/test-category-id')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_category_create_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/category/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_assemble_control_cmsapplication_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsapplication')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_article_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/article/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const core_express_content_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/core/express/content/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_assemble_control_cmsdocument_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/cmsdocument')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_article_create_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/article/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const core_express_article_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/core/express/article/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_article_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/article')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const cms_view_unpublish_view_001_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/view/unpublish/view-001')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_cms_asse_559_q } = useQuery({
  queryKey: ['api_cms_asse_559', '/jaxrs/cms_assemble_control/document/search'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/document/search')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_cms_asse_804_q } = useQuery({
  queryKey: ['api_cms_asse_804', '/jaxrs/cms_assemble_control/get/control/config'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/get/control/config')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_cms_asse_862_q } = useQuery({
  queryKey: ['api_cms_asse_862', '/jaxrs/cms_assemble_control/list/control/sections'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/list/control/sections')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_cms_asse_501_q } = useQuery({
  queryKey: ['api_cms_asse_501', '/jaxrs/cms_assemble_control/update/control/config'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/update/control/config')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_an_996_q } = useQuery({
  queryKey: ['api_jaxrs_an_996', '/jaxrs/anonymous/document/filter/list/i-1/next/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/anonymous/document/filter/list/i-1/next/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_an_237_q } = useQuery({
  queryKey: ['api_jaxrs_an_237', '/jaxrs/anonymous/document/filter/list/p-1/size/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/anonymous/document/filter/list/p-1/size/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_an_787_q } = useQuery({
  queryKey: ['api_jaxrs_an_787', '/jaxrs/anonymous/form/v2/lookup/document/d-1/mobile'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/anonymous/form/v2/lookup/document/d-1/mobile')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cm_42_q } = useQuery({
  queryKey: ['api_jaxrs_cm_42', '/jaxrs/cms/assemble/control/appinfo/alias/alias'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/appinfo/alias/alias')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_820_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_820', '/jaxrs/cms/assemble/control/categoryinfo/alias/alias'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/categoryinfo/alias/alias')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_441_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_441', '/jaxrs/cms/assemble/control/document/cipher/publish/content'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/document/cipher/publish/content')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_446_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_446', '/jaxrs/cms/assemble/control/fileinfo/upload/with/url'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/assemble/control/fileinfo/upload/with/url')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_contro_561_q } = useQuery({
  queryKey: ['api_jaxrs_cms_contro_561', '/jaxrs/cms/control/any/route'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms/control/any/route')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_881_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_881', '/jaxrs/cms_assemble_control/anonymous/document/filter/list/id/next/count'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/anonymous/document/filter/list/id/next/count')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_479_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_479', '/jaxrs/cms_assemble_control/anonymous/document/filter/list/page/size/size'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/anonymous/document/filter/list/page/size/size')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_716_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_716', '/jaxrs/cms_assemble_control/appinfo/filter/list/id/next/count'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/appinfo/filter/list/id/next/count')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_cms_assemb_879_q } = useQuery({
  queryKey: ['api_jaxrs_cms_assemb_879', '/jaxrs/cms_assemble_control/appinfo/filter/list/id/prev/count'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/cms_assemble_control/appinfo/filter/list/id/prev/count')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
