...
const assemble_control_qrcode_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/qrcode/list')
...
const assemble_control_securityclearance_enable_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/enable')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_assemble_control_invoice_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_core_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/core/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_assemble_control_office_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/office')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_dict_item_create_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/dict/item/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_area_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/area/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_config_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/config/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_attendscope_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/attendscope/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_excel_upload_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/excel/upload')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_area_create_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/area/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const dict_item_list_test_dict_id_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/dict/item/list/test-dict-id')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_assemble_config_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/config')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_permissions_mind_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/permissions/mind')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_worktime_isworkday_20240101_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/worktime/isworkday/20240101')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_area_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/area/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_assemble_control_securityclearance_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_securityclearance_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_securityclearance_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_invoice_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_assemble_control_status_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/status')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_worktime_minutesofworkday_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/worktime/minutesofworkday')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_worktime_isworkday_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/worktime/isworkday/')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const assemble_control_upgrade_2021090902_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/upgrade/2021090902')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const general_file_list_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/file/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ap_455_q } = useQuery({
  queryKey: ['api_jaxrs_ap_455', '/jaxrs/appconfig/a-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/appconfig/a-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ap_42_q } = useQuery({
  queryKey: ['api_jaxrs_ap_42', '/jaxrs/appconfig/app-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/appconfig/app-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_co_514_q } = useQuery({
  queryKey: ['api_jaxrs_co_514', '/jaxrs/correlation/core/entity/list/by/user/user-001'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/core/entity/list/by/user/user-001')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_588_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_588',
    '/jaxrs/correlation/service/processing/correlation/delete/type/cms/document/doc-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/delete/type/cms/document/doc-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_co_405_q } = useQuery({
  queryKey: [
    'api_jaxrs_co_405',
    '/jaxrs/correlation/service/processing/correlation/delete/type/processplatform/job/job-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/delete/type/processplatform/job/job-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_128_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_128',
    '/jaxrs/correlation/service/processing/correlation/list/type/cms/document/doc-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/list/type/cms/document/doc-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_39_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_39',
    '/jaxrs/correlation/service/processing/correlation/list/type/cms/document/doc-1/site/site-1',
  ],
  queryFn: async () => {
    try {
...
const { data: api_jaxrs_correlatio_521_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_521',
    '/jaxrs/correlation/service/processing/correlation/list/type/cms/document/doc-l/site/s1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/list/type/cms/document/doc-l/site/s1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_173_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_173',
    '/jaxrs/correlation/service/processing/correlation/list/type/processplatform/job/job-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/list/type/processplatform/job/job-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_939_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_939',
    '/jaxrs/correlation/service/processing/correlation/list/type/processplatform/job/job-1/site/site-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get(
...
const { data: api_jaxrs_correlatio_390_q } = useQuery({
  queryKey: ['api_jaxrs_correlatio_390', '/jaxrs/correlation/service/processing/correlation/readable/type/cms'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/readable/type/cms')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_co_467_q } = useQuery({
  queryKey: ['api_jaxrs_co_467', '/jaxrs/correlation/service/processing/correlation/readable/type/processplatform'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/readable/type/processplatform')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_484_q } = useQuery({
  queryKey: ['api_jaxrs_correlatio_484', '/jaxrs/correlation/service/processing/correlation/type/cms/document/doc-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/type/cms/document/doc-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_correlation_service_processing_correlation_type_processplatform_job_job_1_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/type/processplatform/job/job-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_correlation_service_processing_correlation_type_processplatform_job_job_2_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/type/processplatform/job/job-2')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_347_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_347',
    '/jaxrs/correlation/service/processing/correlation/update/type/cms/document/doc-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/update/type/cms/document/doc-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_549_q } = useQuery({
  queryKey: [
    'api_jaxrs_correlatio_549',
    '/jaxrs/correlation/service/processing/correlation/update/type/cms/document/doc-u',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/update/type/cms/document/doc-u')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_co_571_q } = useQuery({
  queryKey: [
    'api_jaxrs_co_571',
    '/jaxrs/correlation/service/processing/correlation/update/type/processplatform/job/job-1',
  ],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/correlation/update/type/processplatform/job/job-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_correlatio_116_q } = useQuery({
  queryKey: ['api_jaxrs_correlatio_116', '/jaxrs/correlation/service/processing/unlink/message/msg-1/process/proc-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/unlink/message/msg-1/process/proc-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_correlation_service_processing_unlink_type1_id1_type2_id2_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/correlation/service/processing/unlink/type1/id1/type2/id2')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_584_q } = useQuery({
  queryKey: ['api_jaxrs_ge_584', '/jaxrs/general/assemble/control/attendscope/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/attendscope/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_88_q } = useQuery({
  queryKey: ['api_jaxrs_ge_88', '/jaxrs/general/assemble/control/ecnet/check'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/ecnet/check')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_excel_upload_with_url_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/excel/upload/with/url')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_general_as_790_q } = useQuery({
  queryKey: ['api_jaxrs_general_as_790', '/jaxrs/general/assemble/control/generalfile'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/generalfile')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_799_q } = useQuery({
  queryKey: ['api_jaxrs_ge_799', '/jaxrs/general/assemble/control/invoice/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_invoice_upload_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice/upload')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_807_q } = useQuery({
  queryKey: ['api_jaxrs_ge_807', '/jaxrs/general/assemble/control/invoice/upload/for/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice/upload/for/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_invoice_upload_with_url_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/invoice/upload/with/url')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_office_html_to_word_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/office/html/to/word')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_132_q } = useQuery({
  queryKey: ['api_jaxrs_ge_132', '/jaxrs/general/assemble/control/qrcode'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/qrcode')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_60_q } = useQuery({
  queryKey: ['api_jaxrs_ge_60', '/jaxrs/general/assemble/control/securityclearance/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_securityclearance_subject_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/subject')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_securityclearance_system_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/securityclearance/system')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_638_q } = useQuery({
  queryKey: ['api_jaxrs_ge_638', '/jaxrs/general/assemble/control/status/update'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/status/update')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_general_assemble_control_upgrade_2021090901_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/upgrade/2021090901')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_840_q } = useQuery({
  queryKey: ['api_jaxrs_ge_840', '/jaxrs/general/assemble/control/worktime/isholiday/2024-01-01'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/worktime/isholiday/2024-01-01')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_83_q } = useQuery({
  queryKey: ['api_jaxrs_ge_83', '/jaxrs/general/assemble/control/worktime/minutes/of/workday'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/assemble/control/worktime/minutes/of/workday')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_general_di_728_q } = useQuery({
  queryKey: ['api_jaxrs_general_di_728', '/jaxrs/general/dict/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/dict/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_general_di_462_q } = useQuery({
  queryKey: ['api_jaxrs_general_di_462', '/jaxrs/general/dict/list'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/dict/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_general_fi_958_q } = useQuery({
  queryKey: ['api_jaxrs_general_fi_958', '/jaxrs/general/file/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/file/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_977_q } = useQuery({
  queryKey: ['api_jaxrs_ge_977', '/jaxrs/general/invoice/create'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/invoice/create')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_general_in_370_q } = useQuery({
  queryKey: ['api_jaxrs_general_in_370', '/jaxrs/general/invoice/list'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/invoice/list')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_ge_489_q } = useQuery({
  queryKey: ['api_jaxrs_ge_489', '/jaxrs/general/securityclearance/enable'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/general/securityclearance/enable')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
