<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>流程表单设计器</h1>
        <p class="subtitle">/jaxrs/processplatform/assemble/designer/form/list</p>
      </div>
...
const ep = '/jaxrs/processplatform/assemble/designer/form/list';
const qk = ['process_FormDesigner', 'list'];
