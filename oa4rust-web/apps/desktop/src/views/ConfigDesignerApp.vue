<template>
  <div class="editor-view">
    <div class="view-header glass-card">
      <div><h1>配置设计器</h1><p class="subtitle">/jaxrs/config/list</p></div>
...
const ep='/jaxrs/config/list';
const {data}=useQuery({queryKey:['ConfigDesigner','list'],queryFn:async()=>{loading.value=true;try{const r=await api.get(ep);return(r as any)?.data??[]}finally{loading.value=false}}})
