<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>流程字典设计器</h1>
        <p class="subtitle">/jaxrs/processplatform/assemble/designer/dict/list</p>
      </div>
...
const ep = '/jaxrs/processplatform/assemble/designer/dict/list';
const qk = ['process_DictionaryDesigner', 'list'];
