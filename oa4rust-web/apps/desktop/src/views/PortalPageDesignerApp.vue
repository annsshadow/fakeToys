<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>门户页面设计器</h1>
        <p class="subtitle">/jaxrs/portal/assemble/designer/page/list</p>
      </div>
...
const ep = '/jaxrs/portal/assemble/designer/page/list';
const qk = ['portal_PageDesigner', 'list'];
