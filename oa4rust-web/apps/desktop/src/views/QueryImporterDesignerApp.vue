<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>导入设计器</h1>
        <p class="subtitle">/jaxrs/query/assemble/designer/importer/list</p>
      </div>
...
const ep = '/jaxrs/query/assemble/designer/importer/list';
const qk = ['query_ImporterDesigner', 'list'];
