...
async function loadResidualStub() {
  const s = <T>(p: Promise<T>): Promise<T | null> => p.catch(() => null)
  await Promise.all([
    s(api.post('/api/processplatform/assemble/designer/file/upload/0', {})),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/work/0/stream')),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/workcompleted/0/stream')),
    s(api.post('/api/processplatform/assemble/surface/attachment/upload/work/0', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/upload/work/0/callback/0', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/upload/workcompleted/0', {})),
    s(api.put('/api/processplatform/assemble/surface/attachment/upload/work/0/save/as/0', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/v2/upload/workorworkcompleted/0', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/v2/upload/workorworkcompleted/0/base64', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/batch/upload/manage', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/html/to/pdf', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/html/to/image', {})),
    s(api.post('/api/processplatform/assemble/surface/attachment/upload/with/url', {})),
    s(api.get('/api/processplatform/assemble/surface/attachment/batch/download/job/0/site/0')),
    s(api.get('/api/processplatform/assemble/surface/attachment/batch/download/work/0/site/0/stream')),
    s(api.post('/api/processplatform/assemble/surface/snap/upload', {})),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/work/0/stream/0')),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/work/0/0')),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/workcompleted/0/stream/0')),
    s(api.get('/api/processplatform/assemble/surface/attachment/download/0/workcompleted/0/0')),
    s(api.get('/api/processplatform/assemble/designer/item/access/path/path')),
    s(api.get('/api/processplatform/assemble/surface/correlation/job/job')),
    s(api.post('/api/processplatform/assemble/surface/correlation/job/job/delete', {})),
    s(api.get('/api/processplatform/assemble/surface/correlation/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/correlation/list/job/job/site/site')),
    s(api.post('/api/processplatform/assemble/surface/correlation/update/job/job', {})),
    s(api.get('/api/processplatform/assemble/surface/data/fetch/job/job')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/array/data')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0/path1')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0/path1/path2')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0/path1/path2/path3')),
    ...
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0/path1/path2/path3/path4/path5/path6')),
    s(api.get('/api/processplatform/assemble/surface/data/job/job/path0/path1/path2/path3/path4/path5/path6/path7')),
    s(api.get('/api/processplatform/assemble/surface/datarecord/get/job/job/path/path')),
    s(api.get('/api/processplatform/assemble/surface/datarecord/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/documentversion/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/documentversion/work/work')),
    s(api.get('/api/processplatform/assemble/surface/form/v2/lookup/taskcompleted/taskcompleted')),
    s(api.get('/api/processplatform/assemble/surface/form/v2/lookup/taskcompleted/taskcompleted/mobile')),
    s(api.get('/api/processplatform/assemble/surface/job/job/allow/visit/person/person')),
    s(api.get('/api/processplatform/assemble/surface/job/job/find/work/workcompleted')),
    s(api.get('/api/processplatform/assemble/surface/job/latest/work/workcompleted/serial/serial')),
    s(api.get('/api/processplatform/assemble/surface/job/v2/job/projection')),
    s(api.get('/api/processplatform/assemble/surface/keylock/lock')),
    s(api.get('/api/processplatform/assemble/surface/mode/clear/person/person/manager')),
    s(api.post('/api/processplatform/assemble/surface/mode/save', {})),
    s(api.get('/api/processplatform/assemble/surface/read/filter/attribute')),
    s(api.get('/api/processplatform/assemble/surface/read/filter/attribute/filter')),
    s(api.get('/api/processplatform/assemble/surface/read/list/date/date/manage')),
    s(api.get('/api/processplatform/assemble/surface/read/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/read/list/person/person/manage')),
    s(api.get('/api/processplatform/assemble/surface/read/list/work/work')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/filter/attribute')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/filter/attribute/filter')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/list/date/date/manage')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/list/work/work')),
    s(api.get('/api/processplatform/assemble/surface/readrecord/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/record/job/job/manage')),
    s(api.get('/api/processplatform/assemble/surface/record/list/job/job')),
    s(api.post('/api/processplatform/assemble/surface/review/create/work', {})),
    s(api.post('/api/processplatform/assemble/surface/review/create/workcompleted', {})),
    s(api.get('/api/processplatform/assemble/surface/review/filter/attribute')),
    s(api.post('/api/processplatform/assemble/surface/review/filter/create/entry', {})),
    s(api.get('/api/processplatform/assemble/surface/review/filter/entry')),
    s(api.get('/api/processplatform/assemble/surface/review/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/review/v2/search')),
    s(api.get('/api/processplatform/assemble/surface/sign/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/task/filter/attribute')),
    s(api.get('/api/processplatform/assemble/surface/task/filter/attribute/filter')),
    s(api.get('/api/processplatform/assemble/surface/task/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/task/list/work/work')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/filter/attribute')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/filter/attribute/filter')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/list/date/date/hour/hour/manage')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/list/job/job')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/list/work/work')),
    s(api.post('/api/processplatform/assemble/surface/taskcompleted/press/work/work', {})),
    s(api.get('/api/processplatform/assemble/surface/work/v3/retract')),
    s(api.get('/api/processplatform/assemble/surface/work/v3/retract/stage/job/job')),
    s(api.get('/api/processplatform/assemble/surface/workcompleted/shift/time')),
    s(api.get('/api/processplatform/assemble/surface/worklog/list/job/job')),
    s(api.post('/api/processplatform/service/processing/record/task/processing', {})),
    s(api.get('/api/processplatform/service/processing/review/init/review')),
    s(api.post('/api/processplatform/service/processing/touch/deletedraft', {})),
    s(api.post('/api/processplatform/service/processing/touch/handoverjob', {})),
    s(api.post('/api/processplatform/service/processing/touch/mergeitem', {})),
    s(api.post('/api/processplatform/service/processing/touch/touchdelay', {})),
    s(api.post('/api/processplatform/service/processing/touch/urge', {})),
    s(api.get('/api/processplatform/service/processing/workcompleted/shift/time')),
    s(api.get('/api/processplatform/service/processing/touch/merge')),
    s(api.post('/api/processplatform/assemble/surface/attachment/update/0/work/0/callback/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/task/application/process/activity/by/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/task/application/process/activity/0/0/0/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/task/application/process/by/activity/0/0/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/task/application/by/process/0/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/application/process/by/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/application/process/0/0/0/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/bam/period/list/application/by/process/0/0/0/0/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/designer/application/0/0', {})),
    s(api.get('/api/processplatform/assemble/designer/0/0')),
    s(api.post('/api/processplatform/assemble/designer/mergeitemplan/list/application/paging/0/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/designer/mergeitemplan/list/paging/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/designer/process/0/0', {})),
    s(api.post('/api/processplatform/assemble/designer/process/edition/0/0', {})),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/path3/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/path3/path4/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/path3/path4/path5/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/path3/path4/path5/path6/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/applicationdict/application/path0/path1/path2/path3/path4/path5/path6/path7/data/0/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/path2/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/path2/path3/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/path2/path3/path4/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/path2/path3/path4/path5/path6/0')),
    s(api.get('/api/processplatform/assemble/surface/data/work/path0/path1/path2/path3/path4/path5/path6/path7/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/path2/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/path2/path3/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/path2/path3/path4/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/path2/path3/path4/path5/path6/0')),
    s(api.get('/api/processplatform/assemble/surface/data/workcompleted/path0/path1/path2/path3/path4/path5/path6/path7/0')),
    s(api.get('/api/processplatform/assemble/surface/documentversion/list/workorworkcompleted/0/0/0')),
    s(api.post('/api/processplatform/assemble/surface/read/v2/list/create/paging/0/0/0', {})),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/list/my/paging/0/0/0')),
    s(api.post('/api/processplatform/assemble/surface/readcompleted/v2/list/create/paging/0/0/0', {})),
    s(api.post('/api/processplatform/assemble/surface/review/v2/list/create/paging/0/0/0', {})),
    s(api.get('/api/processplatform/assemble/surface/task/list/my/paging/0/0/0')),
    s(api.post('/api/processplatform/assemble/surface/task/v2/list/create/paging/0/0/0', {})),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/list/my/paging/0/0/0')),
    s(api.post('/api/processplatform/assemble/surface/taskcompleted/v2/list/create/paging/0/0/0', {})),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/path3/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/path3/path4/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/path3/path4/path5/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/path3/path4/path5/path6/data/0')),
    s(api.get('/api/processplatform/service/processing/applicationdict/path0/path1/path2/path3/path4/path5/path6/path7/data/0')),
    s(api.get('/api/processplatform/service/processing/attachment/0/0/0')),
    s(api.get('/api/processplatform/service/processing/data/0/0')),
    s(api.get('/api/processplatform/service/processing/0/0')),
    s(api.get('/api/processplatform/service/processing/record/0/0')),
    s(api.post('/api/processplatform/service/processing/taskcompleted/press/0/0/0', {})),
    s(api.get('/api/processplatform/assemble/surface/anonymous/read/0/0')),
    s(api.get('/api/processplatform/assemble/surface/anonymous/task/0/0')),
    s(api.get('/api/processplatform/assemble/surface/read/0/0')),
    s(api.get('/api/processplatform/assemble/surface/readcompleted/0/0')),
    s(api.get('/api/processplatform/assemble/surface/task/0/0')),
    s(api.get('/api/processplatform/assemble/surface/taskcompleted/0/0')),
    s(api.get('/api/processplatform/assemble/surface/work/0/0')),
    s(api.post('/api/processplatform/service/processing/series/series/activitytoken/processing/signal/0/0/0', {})),
  ])
}
</script>
