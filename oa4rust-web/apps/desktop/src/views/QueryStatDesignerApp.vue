<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>统计设计器</h1>
        <p class="subtitle">/jaxrs/query/assemble/designer/stat/list</p>
      </div>
...
const ep = '/jaxrs/query/assemble/designer/stat/list';
const qk = ['query_StatDesigner', 'list'];
