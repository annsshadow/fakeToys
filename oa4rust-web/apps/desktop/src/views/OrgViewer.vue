...
async function loadResidualStub() {
  const s = <T>(p: Promise<T>): Promise<T | null> => p.catch(() => null)
  await Promise.all([
    s(api.post('/api/person/signature/upload', {})),
    s(api.post('/api/person/icon/upload', {})),
    s(api.get('/api/authentication/bind')),
    s(api.delete('/api/authentication')),
    s(api.post('/api/authentication/code', {})),
    s(api.post('/api/authentication/safe/logout', {})),
    s(api.get('/api/authentication/oidc/authorize')),
    s(api.get('/api/authentication/oidc/callback')),
    s(api.post('/api/authentication/sms/send', {})),
    s(api.post('/api/authentication/sms/verify', {})),
    s(api.delete('/api/organization/assemble/authentication/authentication')),
    s(api.get('/api/organization/assemble/authentication/authentication')),
    s(api.post('/api/organization/assemble/authentication/authentication/code', {})),
    s(api.get('/api/organization/assemble/authentication/authentication/safe/logout')),
    s(api.put('/api/organization/assemble/authentication/authentication/switchuser', {})),
    s(api.get('/api/organization/assemble/authentication/authentication/bind')),
    s(api.post('/api/organization/assemble/authentication/dingding/info', {})),
    s(api.post('/api/organization/assemble/authentication/zhengwudingding/info', {})),
    s(api.post('/api/organization/assemble/authentication/qiyeweixin/info/sign', {})),
    s(api.get('/api/organization/assemble/control/export/zhengwudingding/person')),
    s(api.get('/api/organization/assemble/authentication/qiyeweixin/bind/0/callback/0')),
    s(api.get('/api/organization/assemble/authentication/dingding/bind/0/callback/0')),
    s(api.get('/api/organization/assemble/authentication/zhengwudingding/bind/0/callback/0')),
    s(api.post('/api/organization/assemble/authentication/mpweixin/menu/test/send/to/0', {})),
    s(api.get('/api/authentication/bind/meta/0')),
    s(api.post('/api/authentication/bind/meta/0', {})),
    s(api.post('/api/organization/assemble/authentication/qiyeweixin/bind/0/confirm', {})),
    s(api.post('/api/organization/assemble/authentication/dingding/bind/0/confirm', {})),
    s(api.post('/api/organization/assemble/authentication/zhengwudingding/bind/0/confirm', {})),
    s(api.post('/api/organization/assemble/authentication/bind/meta/0', {})),
    s(api.get('/api/organization/assemble/authentication/qiyeweixin/update/person/detail/0')),
    s(api.get('/api/organization/assemble/authentication/authentication/bind/meta/0')),
    s(api.post('/api/organization/assemble/authentication/authentication/bind/meta/0', {})),
    s(api.get('/api/authentication/captcha/width/0/height/0')),
    s(api.post('/api/authentication', {})),
    s(api.get('/api/authentication/code/credential/0')),
    ...
    s(api.get('/api/authentication/oauth/name/0')),
    s(api.get('/api/authentication/oauth/login/qywx/code/0')),
    s(api.get('/api/authentication/oauth/login/dingding/code/0')),
    s(api.get('/api/authentication/oauth/login/name/0/code/0/redirecturi/0')),
    s(api.get('/api/authentication/oauth/bind/name/0/code/0/redirecturi/0')),
    s(api.post('/api/authentication/two_factor', {})),
    s(api.post('/api/authentication/check/token', {})),
    s(api.post('/api/authentication/sso', {})),
    s(api.post('/api/authentication/sso/encrypt', {})),
    s(api.get('/api/authentication/sso/client/0/token/0')),
    s(api.get('/api/organization/assemble/authentication/qiyeweixin/login/0')),
    s(api.get('/api/organization/assemble/authentication/dingding/login/0')),
    s(api.get('/api/organization/assemble/authentication/zhengwudingding/login/0')),
    s(api.post('/api/organization/assemble/authentication/authentication', {})),
    s(api.post('/api/organization/assemble/authentication/authentication/captcha', {})),
    s(api.post('/api/organization/assemble/authentication/authentication/two/factory/login', {})),
    s(api.get('/api/organization/assemble/authentication/authentication/code/credential/0')),
    s(api.post('/api/organization/assemble/authentication/authentication/check/token', {})),
    s(api.get('/api/organization/assemble/authentication/sso/encrypt/client/0/key/0/credential/0')),
    s(api.post('/api/organization/assemble/authentication/sso', {})),
    s(api.post('/api/organization/assemble/authentication/sso/encrypt', {})),
    s(api.get('/api/organization/assemble/authentication/sso/client/0/token/0')),
    s(api.get('/api/organization/assemble/authentication/dingding/code/0')),
    s(api.get('/api/organization/assemble/authentication/oauth/auth')),
    s(api.post('/api/organization/assemble/authentication/oauth/generate/code', {})),
    s(api.get('/api/organization/assemble/authentication/oauth/info')),
    s(api.post('/api/organization/assemble/authentication/oauth/info', {})),
    s(api.get('/api/organization/assemble/authentication/oauth/info/jira')),
    s(api.post('/api/organization/assemble/authentication/oauth/info/jira', {})),
    s(api.get('/api/organization/assemble/authentication/oauth/token')),
    s(api.post('/api/organization/assemble/authentication/oauth/token', {})),
    s(api.post('/api/organization/assemble/authentication/oauth/token/jira', {})),
    s(api.get('/api/organization/assemble/authentication/authentication/oauth/name/0')),
    s(api.get('/api/organization/assemble/authentication/authentication/oauth/login/name/0/code/0/redirecturi/0')),
    s(api.get('/api/organization/assemble/authentication/authentication/oauth/login/qywx/code/0')),
    s(api.get('/api/organization/assemble/authentication/authentication/oauth/login/dingding/code/0')),
    s(api.get('/api/organization/assemble/authentication/authentication/oauth/bind/name/0/code/0/redirecturi/0')),
    s(api.get('/api/organization/assemble/authentication/mpweixin/login/code/0')),
    s(api.get('/api/organization/assemble/authentication/mpweixin/bind/openid/0')),
    s(api.get('/api/organization/assemble/authentication/mpweixin/bind/code/0')),
    s(api.get('/api/organization/assemble/authentication/qiyeweixin/code/0')),
    s(api.get('/api/organization/assemble/authentication/welink/code/0')),
    s(api.get('/api/organization/assemble/authentication/zhengwudingding/code/0')),
    s(api.get('/api/organization/assemble/authentication/andfx/moa/sso/token/0/enter/0')),
    s(api.get('/api/organization/assemble/control/person/0/reset/password')),
    s(api.get('/api/organization/assemble/control/person/check/password/0')),
    s(api.get('/api/organization/assemble/control/person/0/set/password/expired/time/0')),
    s(api.post('/api/person/regist', {})),
    s(api.post('/api/person/regist/code', {})),
    s(api.get('/api/person/regist/captcha/width/0/height/0')),
    s(api.get('/api/person/regist/code/mobile/0')),
    s(api.get('/api/person/regist/check/password/0')),
  ])
}
</script>
<style scoped>
