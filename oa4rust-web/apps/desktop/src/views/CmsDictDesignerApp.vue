<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>CMS字典设计器</h1>
        <p class="subtitle">/jaxrs/cms/assemble/control/dict/list</p>
      </div>
...
const ep = '/jaxrs/cms/assemble/control/dict/list';
const qk = ['cms_DictionaryDesigner', 'list'];
