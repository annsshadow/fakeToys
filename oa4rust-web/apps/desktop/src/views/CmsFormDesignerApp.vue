<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>CMS表单设计器</h1>
        <p class="subtitle">/jaxrs/cms/assemble/control/form/list</p>
      </div>
...
const ep = '/jaxrs/cms/assemble/control/form/list';
const qk = ['cms_FormDesigner', 'list'];
