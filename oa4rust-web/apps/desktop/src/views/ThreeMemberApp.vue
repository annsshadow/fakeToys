<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div><h1>三方成员管理</h1><p class="subtitle">/jaxrs/organization/assemble/control/threemember/list</p></div>
...
const ep='/jaxrs/organization/assemble/control/threemember/list';
