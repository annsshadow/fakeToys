<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>CMS视图设计器</h1>
        <p class="subtitle">/jaxrs/cms/assemble/control/view/list</p>
      </div>
...
const ep = '/jaxrs/cms/assemble/control/view/list';
const qk = ['cms_ViewDesigner', 'list'];
