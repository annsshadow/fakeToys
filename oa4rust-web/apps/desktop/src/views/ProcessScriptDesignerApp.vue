<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>流程脚本设计器</h1>
        <p class="subtitle">/jaxrs/processplatform/assemble/designer/script/list</p>
      </div>
...
const ep = '/jaxrs/processplatform/assemble/designer/script/list';
const qk = ['process_ScriptDesigner', 'list'];
