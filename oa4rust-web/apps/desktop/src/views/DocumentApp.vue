...
const document_category_change_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/category/change')
...
const document_d_1_update_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/update')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_publish_d_1_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/publish/d-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_commend_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/commend')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_permission_read_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/permission/read')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_uncommend_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/uncommend')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_batch_b_1_status_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/b-1/status')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_batch_u3_batch_x_status_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/u3-batch-x/status')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_view_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/view')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_batch_u3_batch_x_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/u3-batch-x')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_publish_d_1_cancel_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/publish/d-1/cancel')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_publish_content_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/publish/content')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_document_fields_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/document/fields')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_view_count_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/view/count')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_control_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/control')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_d_1_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const document_batch_data_modify_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/data/modify')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_q } = useQuery({
  queryKey: ['api_jaxrs_document', '/jaxrs/document'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_359_q } = useQuery({
  queryKey: ['api_jaxrs_do_359', '/jaxrs/document/achive/d-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/achive/d-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_831_q } = useQuery({
  queryKey: ['api_jaxrs_do_831', '/jaxrs/document/batch'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_494_q } = useQuery({
  queryKey: ['api_jaxrs_do_494', '/jaxrs/document/batch/b-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/b-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_532_q } = useQuery({
  queryKey: ['api_jaxrs_do_532', '/jaxrs/document/batch/status'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/batch/status')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_862_q } = useQuery({
  queryKey: ['api_jaxrs_do_862', '/jaxrs/document/cipher/c-1/permission/read/person/p-1'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/cipher/c-1/permission/read/person/p-1')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_389_q } = useQuery({
  queryKey: ['api_jaxrs_do_389', '/jaxrs/document/cipher/filter/list/p-1/size/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/cipher/filter/list/p-1/size/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_733_q } = useQuery({
  queryKey: ['api_jaxrs_do_733', '/jaxrs/document/cipher/publish/content'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/cipher/publish/content')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_392_q } = useQuery({
  queryKey: ['api_jaxrs_do_392', '/jaxrs/document/d-1/document/data'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/document/data')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_98_q } = useQuery({
  queryKey: ['api_jaxrs_do_98', '/jaxrs/document/d-1/persons'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/persons')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_590_q } = useQuery({
  queryKey: ['api_jaxrs_do_590', '/jaxrs/document/d-1/top'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/top')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_do_500_q } = useQuery({
  queryKey: ['api_jaxrs_do_500', '/jaxrs/document/d-1/unTop'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/d-1/unTop')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_d_142_q } = useQuery({
  queryKey: ['api_jaxrs_document_d_142', '/jaxrs/document/draft/list/i-1/next/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/draft/list/i-1/next/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_f_206_q } = useQuery({
  queryKey: ['api_jaxrs_document_f_206', '/jaxrs/document/filter/count'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/filter/count')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_f_644_q } = useQuery({
  queryKey: ['api_jaxrs_document_f_644', '/jaxrs/document/filter/list/i-1/next/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/filter/list/i-1/next/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_f_856_q } = useQuery({
  queryKey: ['api_jaxrs_document_f_856', '/jaxrs/document/filter/list/i-1/size/10/manager'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/filter/list/i-1/size/10/manager')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_l_753_q } = useQuery({
  queryKey: ['api_jaxrs_document_l_753', '/jaxrs/document/list/document'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/list/document')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_document_l_855_q } = useQuery({
  queryKey: ['api_jaxrs_document_l_855', '/jaxrs/document/list/document/data'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/document/list/document/data')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
