<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div><h1>神经网络AI配置</h1><p class="subtitle">/jaxrs/ai/assemble/control/ann/list</p></div>
...
const ep='/jaxrs/ai/assemble/control/ann/list';const qk=['ANN','list'];
