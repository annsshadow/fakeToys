<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>表格设计器</h1>
        <p class="subtitle">/jaxrs/query/assemble/surface/table/list</p>
      </div>
...
const ep = '/jaxrs/query/assemble/surface/table/list';
const qk = ['query_TableDesigner', 'list'];
