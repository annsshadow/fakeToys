<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>流程XForm</h1>
        <p class="subtitle">/jaxrs/processplatform/assemble/designer/xform/list</p>
      </div>
...
const ep = '/jaxrs/processplatform/assemble/designer/xform/list';
const qk = ['process_Xform', 'list'];
