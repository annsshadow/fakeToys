<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>CMS脚本设计器</h1>
        <p class="subtitle">/jaxrs/cms/assemble/control/script/list</p>
      </div>
...
const ep = '/jaxrs/cms/assemble/control/script/list';
const qk = ['cms_ScriptDesigner', 'list'];
