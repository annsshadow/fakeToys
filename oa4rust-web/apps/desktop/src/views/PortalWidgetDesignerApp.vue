<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>门户组件设计器</h1>
        <p class="subtitle">/jaxrs/portal/assemble/designer/widget/list</p>
      </div>
...
const ep = '/jaxrs/portal/assemble/designer/widget/list';
const qk = ['portal_WidgetDesigner', 'list'];
