<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>门户字典设计器</h1>
        <p class="subtitle">/jaxrs/portal/assemble/designer/dict/list</p>
      </div>
...
const ep = '/jaxrs/portal/assemble/designer/dict/list';
const qk = ['portal_DictionaryDesigner', 'list'];
