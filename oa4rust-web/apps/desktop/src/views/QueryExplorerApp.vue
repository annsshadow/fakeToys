<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>查询浏览器</h1>
        <p class="subtitle">/jaxrs/query/assemble/surface/explorer/list</p>
      </div>
...
const ep = '/jaxrs/query/assemble/surface/explorer/list';
const qk = ['query_QueryExplorer', 'list'];
