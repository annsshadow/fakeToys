<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>通用选择器</h1>
        <p class="subtitle">/jaxrs/organization/assemble/control/person/list</p>
      </div>
...
const ep = '/jaxrs/organization/assemble/control/person/list';
const qk = ['Selector', 'list'];
