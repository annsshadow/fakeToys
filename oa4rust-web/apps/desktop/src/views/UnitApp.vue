...
const list_person_sup_nested_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/person/sup/nested')
...
const unit_list_level_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/level')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_unit_tree_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unit/tree')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_identity_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/identity')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_check_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/check')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_unitattribute_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unitattribute/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_identity_type_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/identity/type')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_identity_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/identity/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const list_unit_sup_nested_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unit/sup/nested')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const check_unit_has_unit_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/check/unit/has/unit')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_person_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/person')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const list_type_dept_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/type/dept/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const check_unit_has_identity_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/check/unit/has/identity')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_unitattribute_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unitattribute')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const list_unit_sub_nested_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unit/sub/nested')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_identity_level_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/identity/level')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_identity_type_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/identity/type/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const list_level_name_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/level/name/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_unitduty_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unitduty/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_identity_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/identity')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const list_unit_sub_direct_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/unit/sub/direct')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_person_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/person/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const unit_list_all_object_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/unit/list/all/object')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_or_150_q } = useQuery({
  queryKey: ['api_jaxrs_or_150', '/jaxrs/organization/assemble/authentication/authentication/oauth/dingding/config'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/authentication/authentication/oauth/dingding/config')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_or_60_q } = useQuery({
  queryKey: ['api_jaxrs_or_60', '/jaxrs/organization/assemble/authentication/authentication/oauth/qywx/config'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/authentication/authentication/oauth/qywx/config')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
  ...
  queryFn: async () => {
    try {
      const r = await api.get(
        '/jaxrs/organization/assemble/authentication/sso/encrypt/client/u2c/key/u2key-1234567890-abcdef-/credential/user@P',
      )
      return (r.data ?? []) as any[]
    } catch {
      return []
...
const { data: api_jaxrs_or_174_q } = useQuery({
  queryKey: ['api_jaxrs_or_174', '/jaxrs/organization/assemble/control/group/list/like/pinyin'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/group/list/like/pinyin')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_494_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_494', '/jaxrs/organization/assemble/control/identity/list/like/pinyin'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/identity/list/like/pinyin')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_346_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_346', '/jaxrs/organization/assemble/control/person/list/like/pinyin'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/person/list/like/pinyin')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_256_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_256', '/jaxrs/organization/assemble/control/role/list/0/next/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/role/list/0/next/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_285_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_285', '/jaxrs/organization/assemble/control/role/list/like/pinyin'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/role/list/like/pinyin')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_824_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_824', '/jaxrs/organization/assemble/control/unit/list/0/next/10'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/0/next/10')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_923_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_923', '/jaxrs/organization/assemble/control/unit/list/control/top'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/control/top')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_439_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_439', '/jaxrs/organization/assemble/control/unit/list/like/pinyin'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/like/pinyin')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_organization_assemble_control_unit_list_test_unit_sub_nested_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/test-unit/sub/nested')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_organization_assemble_control_unit_list_test_unit_sup_nested_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/test-unit/sup/nested')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const jaxrs_organization_assemble_control_unit_list_test_unit_sup_nested_type_company_q = useQuery({
  ...
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/test-unit/sup/nested/type/company')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
...
const { data: api_jaxrs_organizati_842_q } = useQuery({
  queryKey: ['api_jaxrs_organizati_842', '/jaxrs/organization/assemble/control/unit/list/unit/type'],
  queryFn: async () => {
    try {
      const r = await api.get('/jaxrs/organization/assemble/control/unit/list/unit/type')
      return (r.data ?? []) as any[]
    } catch {
      return []
    }
