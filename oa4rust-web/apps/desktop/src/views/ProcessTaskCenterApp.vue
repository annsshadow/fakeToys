<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>流程任务中心</h1>
        <p class="subtitle">/jaxrs/processplatform/service/processing/task/list</p>
      </div>
...
const ep = '/jaxrs/processplatform/service/processing/task/list';
const qk = ['process_TaskCenter', 'list'];
