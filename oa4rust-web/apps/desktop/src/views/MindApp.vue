...
const { data: api_entity_f_578_q } = useQuery({queryKey: ['api_entity_f_578', '/jaxrs/mind/core/entity/folder/folder-001'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/core/entity/folder/folder-001"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_mind_version_data = ref<any[]>([]);
const { data: api_mind_version_q } = useQuery({queryKey: ['api_mind_version', '/jaxrs/mind/version'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/version"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_mind_data = ref<any[]>([]);
const { data: api_mind_mind_q } = useQuery({queryKey: ['api_mind_mind', '/jaxrs/mind/mind'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/mind"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_folder_x_force_data = ref<any[]>([]);
const { data: api_folder_x_force_q } = useQuery({queryKey: ['api_folder_x_force', '/jaxrs/mind/assemble/control/folder/x/force'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/folder/x/force"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_recycle_x_data = ref<any[]>([]);
const { data: api_mind_recycle_x_q } = useQuery({queryKey: ['api_mind_recycle_x', '/jaxrs/mind/assemble/control/mind/recycle/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/recycle/x"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_view_x_data = ref<any[]>([]);
const { data: api_mind_view_x_q } = useQuery({queryKey: ['api_mind_view_x', '/jaxrs/mind/assemble/control/mind/view/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/view/x"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_core_list_data = ref<any[]>([]);
const { data: api_mind_core_list_q } = useQuery({queryKey: ['api_mind_core_list', '/jaxrs/mind/core/list'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/core/list"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_entity_m_376_data = ref<any[]>([]);
const { data: api_entity_m_376_q } = useQuery({queryKey: ['api_entity_m_376', '/jaxrs/mind/core/entity/mind/mind-001'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/core/entity/mind/mind-001"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_mind_map_data = ref<any[]>([]);
const { data: api_mind_map_q } = useQuery({queryKey: ['api_mind_map', '/jaxrs/mind/map'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/map"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_control__997_data = ref<any[]>([]);
const { data: api_control__997_q } = useQuery({queryKey: ['api_control__997', '/jaxrs/mind/assemble/control/folder/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/folder/x"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_mind_folder_data = ref<any[]>([]);
const { data: api_mind_folder_q } = useQuery({queryKey: ['api_mind_folder', '/jaxrs/mind/folder'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/folder"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_control__448_data = ref<any[]>([]);
const { data: api_control__448_q } = useQuery({queryKey: ['api_control__448', '/jaxrs/mind/assemble/control/mind/save'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/save"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_list_x_s_620_data = ref<any[]>([]);
const { data: api_list_x_s_620_q } = useQuery({queryKey: ['api_list_x_s_620', '/jaxrs/mind/assemble/control/mind/list/x/shareRecords'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/list/x/shareRecords"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_assemble_184_data = ref<any[]>([]);
const { data: api_assemble_184_q } = useQuery({queryKey: ['api_assemble_184', '/jaxrs/mind/assemble/control/config'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/config"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_folder_tree_my_data = ref<any[]>([]);
const { data: api_folder_tree_my_q } = useQuery({queryKey: ['api_folder_tree_my', '/jaxrs/mind/assemble/control/folder/tree/my'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/folder/tree/my"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_x_icon_data = ref<any[]>([]);
const { data: api_mind_x_icon_q } = useQuery({queryKey: ['api_mind_x_icon', '/jaxrs/mind/assemble/control/mind/x/icon'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/x/icon"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_entity_f_454_data = ref<any[]>([]);
const { data: api_entity_f_454_q } = useQuery({queryKey: ['api_entity_f_454', '/jaxrs/mind/core/entity/folder/list'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/core/entity/folder/list"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_list_x_version_data = ref<any[]>([]);
const { data: api_list_x_version_q } = useQuery({queryKey: ['api_list_x_version', '/jaxrs/mind/assemble/control/mind/list/x/version'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/list/x/version"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_mind_ass_232_data = ref<any[]>([]);
const { data: api_mind_ass_232_q } = useQuery({queryKey: ['api_mind_ass_232', '/jaxrs/mind/assemble/list'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/list"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_share_x_cancel_data = ref<any[]>([]);
const { data: api_share_x_cancel_q } = useQuery({queryKey: ['api_share_x_cancel', '/jaxrs/mind/assemble/control/mind/share/x/cancel'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/share/x/cancel"); return (r.data ?? []) as any[]; } catch { return []; } }});
...
const { data: api_control__696_q } = useQuery({queryKey: ['api_control__696', '/jaxrs/mind/assemble/control/mind/x/destoryrecycle'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/x/destoryrecycle"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_entity_v_388_data = ref<any[]>([]);
const { data: api_entity_v_388_q } = useQuery({queryKey: ['api_entity_v_388', '/jaxrs/mind/core/entity/version/list/mind-001'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/core/entity/version/list/mind-001"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_control__12_data = ref<any[]>([]);
const { data: api_control__12_q } = useQuery({queryKey: ['api_control__12', '/jaxrs/mind/assemble/control/mind/restore/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/restore/x"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_mind_ass_989_data = ref<any[]>([]);
const { data: api_mind_ass_989_q } = useQuery({queryKey: ['api_mind_ass_989', '/jaxrs/mind_assemble_control'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind_assemble_control"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_control_mind_ver_254_data = ref<any[]>([]);
const { data: api_control_mind_ver_254_q } = useQuery({queryKey: ['api_control_mind_ver_254', '/jaxrs/mind/assemble/control/mind/version/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/version/x"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_control_mind_x_d_527_data = ref<any[]>([]);
const { data: api_control_mind_x_d_527_q } = useQuery({queryKey: ['api_control_mind_x_d_527', '/jaxrs/mind/assemble/control/mind/x/destorymind'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/x/destorymind"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_control_folder_move_x_data = ref<any[]>([]);
const { data: api_control_folder_move_x_q } = useQuery({queryKey: ['api_control_folder_move_x', '/jaxrs/mind/assemble/control/folder/move/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/folder/move/x"); return (r.data ?? []) as any[]; } catch { return []; } }});
const api_control_mind_share_x_data = ref<any[]>([]);
const { data: api_control_mind_share_x_q } = useQuery({queryKey: ['api_control_mind_share_x', '/jaxrs/mind/assemble/control/mind/share/x'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/share/x"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_jaxrs_mind_assem_234_data = ref<any[]>([]);
const { data: api_jaxrs_mind_assem_234_q } = useQuery({queryKey: ['api_jaxrs_mind_assem_234', '/jaxrs/mind/assemble/control/mind/filter/list/x/next/1'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/filter/list/x/next/1"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_jaxrs_mind_assem_540_data = ref<any[]>([]);
const { data: api_jaxrs_mind_assem_540_q } = useQuery({queryKey: ['api_jaxrs_mind_assem_540', '/jaxrs/mind/assemble/control/mind/filter/recycle/x/next/1'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/filter/recycle/x/next/1"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_jaxrs_mind_assem_93_data = ref<any[]>([]);
const { data: api_jaxrs_mind_assem_93_q } = useQuery({queryKey: ['api_jaxrs_mind_assem_93', '/jaxrs/mind/assemble/control/mind/filter/shared/x/next/1'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/filter/shared/x/next/1"); return (r.data ?? []) as any[]; } catch { return []; } }});

const api_jaxrs_mind_assem_929_data = ref<any[]>([]);
const { data: api_jaxrs_mind_assem_929_q } = useQuery({queryKey: ['api_jaxrs_mind_assem_929', '/jaxrs/mind/assemble/control/mind/x/icon/size/64'], queryFn: async () => { try { const r = await api.get("/jaxrs/mind/assemble/control/mind/x/icon/size/64"); return (r.data ?? []) as any[]; } catch { return []; } }});
