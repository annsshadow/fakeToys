<template>
  <div class="crud-view">
    <div class="view-header glass-card">
      <div>
        <h1>服务调用设计器</h1>
        <p class="subtitle">/jaxrs/program_center/invoke/list</p>
      </div>
...
const ep = '/jaxrs/program_center/invoke/list';
const qk = ['service_InvokeDesigner', 'list'];
