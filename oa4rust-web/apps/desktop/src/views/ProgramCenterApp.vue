...
//（POST script/name/{name} owner 门禁 UPDATE x_program_script，body{name?,content?,category?} 读 handler script_save 核实；
//  GET validation/timeout/{timeout} Path<i64> INSERT x_program_sync_log source=validation action=timeout）
async function loadPcScriptOps() {
  const s = <T>(p: Promise<T>): Promise<T | null> => p.catch(() => null)
  const name = prompt('脚本名:', 'g5') || 'g5'
  try {
    const rs = await Promise.all([
      s(api.post(`/api/program_center/script/name/${encodeURIComponent(name)}`, { content: 'g5' })),
      s(api.get('/api/program_center/validation/timeout/0')),
    ])
...
async function loadPcTwinD() {
  ...
  try {
    const rs = await Promise.all([
      ...
      s(api.post('/api/program_center/collect', {})),
      s(api.put('/api/program_center/collect', {})),
      s(api.put('/api/program_center/collect/urlMapping', {})),
      s(api.put('/api/program_center/config/collect', {})),
    ])
...
async function loadResidualStub() {
  const s = <T>(p: Promise<T>): Promise<T | null> => p.catch(() => null)
  await Promise.all([
    s(api.get('/api/program_center/market/id/download')),
    s(api.post('/api/program_center/module/compare/upload', {})),
    s(api.put('/api/program_center/module/compare/upload', {})),
    s(api.get('/api/program_center/collect/remove')),
    s(api.get('/api/program_center/config/get')),
    s(api.get('/api/program_center/agent/flag')),
    s(api.get('/api/program_center/agent/flag/disable')),
    s(api.get('/api/program_center/agent/flag/enable')),
    s(api.get('/api/program_center/agent/flag/execute')),
    s(api.get('/api/program_center/agent/flag/file')),
    s(api.post('/api/program_center/bar/create/mass/from/count', {})),
    s(api.get('/api/program_center/collect/connect')),
    s(api.get('/api/program_center/collect/controllebbs')),
    s(api.get('/api/program_center/collect/controllermobile/name/name/mobile/mobile')),
    s(api.get('/api/program_center/collect/disconnect')),
    s(api.get('/api/program_center/collect/mobile/check/connect')),
    s(api.get('/api/program_center/collect/name/name/exist')),
    s(api.get('/api/program_center/collect/person')),
    s(api.get('/api/program_center/collect/sync/area')),
    s(api.post('/api/program_center/collect/updateUnit', {})),
    s(api.get('/api/program_center/collect/urlMapping')),
    s(api.get('/api/program_center/collect/validate')),
    s(api.get('/api/program_center/collect/validate/codeanswer')),
    s(api.put('/api/program_center/collect/validate/codeanswer', {})),
    s(api.get('/api/program_center/collect/validate/direct')),
    s(api.put('/api/program_center/collect/validate/direct', {})),
    ...
    s(api.get('/api/program_center/deploy/web/resource/as/new/asNew')),
    s(api.get('/api/program_center/deploy/id')),
    s(api.get('/api/program_center/dict/dictFlag/data')),
    s(api.get('/api/program_center/dict/dictFlag/path/data')),
    s(api.get('/api/program_center/dict/id')),
    s(api.post('/api/program_center/foo/create/mass/from/count', {})),
    s(api.get('/api/program_center/invoke/flag/execute')),
    s(api.get('/api/program_center/invoke/flag/execute/get')),
    s(api.post('/api/program_center/module/output', {})),
    s(api.post('/api/program_center/module/output/structure', {})),
    s(api.post('/api/program_center/module/output/flag/file', {})),
    s(api.get('/api/program_center/module/remove/structure/id')),
    s(api.get('/api/program_center/module/write/flag')),
    s(api.put('/api/program_center/module/write/flag', {})),
    s(api.get('/api/program_center/module/id/compare')),
    s(api.get('/api/program_center/mpweixin/check')),
    s(api.post('/api/program_center/mpweixin/media/add/forever', {})),
    s(api.post('/api/program_center/mpweixin/menu/add', {})),
    s(api.post('/api/program_center/mpweixin/menu/create/to/weixin', {})),
    s(api.delete('/api/program_center/mpweixin/menu/delete/id')),
    s(api.get('/api/program_center/mpweixin/menu/subscribe')),
    s(api.post('/api/program_center/mpweixin/menu/update/id', {})),
    s(api.post('/api/program_center/output/appInfoFlag/select', {})),
    s(api.post('/api/program_center/output/flag/select/file', {})),
    s(api.get('/api/program_center/prompterrorlog/id')),
    s(api.get('/api/program_center/schedule/list/schedulelog/application/application')),
    s(api.get('/api/program_center/schedule/schedule/fire')),
    s(api.get('/api/program_center/script/name/name')),
    s(api.get('/api/program_center/script/name/name/imported')),
    s(api.get('/api/program_center/script/flag')),
    s(api.get('/api/program_center/script/id')),
    s(api.get('/api/program_center/test/test1')),
    s(api.get('/api/program_center/test/test2')),
    s(api.get('/api/program_center/unexpectederrorlog/id')),
    s(api.get('/api/program_center/validation/timeout/timeout')),
    s(api.get('/api/program_center/authentication')),
    s(api.delete('/api/program_center/collect/remove')),
    s(api.put('/api/program_center/collect/updateUnit', {})),
    s(api.delete('/api/program_center/module/remove/structure/id')),
    s(api.put('/api/program_center/mpweixin/menu/update/id', {})),
    s(api.get('/api/program_center/bar/create/mass/0/0')),
    s(api.get('/api/program_center/foo/create/mass/0/0')),
    s(api.get('/api/program_center/bar/select3/field/0/value/0/count/0')),
    s(api.get('/api/program_center/bar/select4/field/0/value/0/count/0')),
    s(api.get('/api/program_center/config-open/get/disable/export/enable')),
    s(api.get('/api/program_center/dingding/request/pull/sync')),
    s(api.post('/api/program_center/dingding/request/pull/sync', {})),
    s(api.get('/api/program_center/dingding/sync/organization/callback')),
    s(api.post('/api/program_center/dingding/sync/organization/callback', {})),
    s(api.get('/api/program_center/mpweixin/message/template/send')),
    s(api.post('/api/program_center/mpweixin/message/template/send', {})),
    s(api.get('/api/program_center/qiyeweixin/get/callback/aes')),
    s(api.get('/api/program_center/qiyeweixin/request/pull/sync')),
    s(api.get('/api/program_center/qiyeweixin/send/getprivateinfo/message')),
    s(api.post('/api/program_center/qiyeweixin/send/getprivateinfo/message', {})),
    s(api.get('/api/program_center/zhengwudingding/sync/organization/callback')),
    s(api.post('/api/program_center/zhengwudingding/sync/organization/callback', {})),
    s(api.get('/api/program_center/qiyeweixin')),
    s(api.post('/api/program_center/qiyeweixin/request/pull/sync', {})),
    s(api.put('/api/program_center/appstyle/image/login/avatar', {})),
    s(api.get('/api/program_center/appstyle/image/login/avatar/erase')),
    s(api.post('/api/program_center/captcha/v2/create/width/width/height/height', {})),
    s(api.get('/api/program_center/captcha/id/validate/answer/answer')),
    s(api.post('/api/program_center/code/create/mobile/mobile', {})),
    s(api.get('/api/program_center/code/validate/mobile/mobile/answer/answer')),
    s(api.get('/api/program_center/code/validate/mobile/mobile/answer/answer/cascade')),
    s(api.get('/api/program_center/collect/code/mobile/mobile')),
    s(api.get('/api/program_center/collect/login')),
    s(api.get('/api/program_center/collect/name/name/mobile/mobile/code/code')),
    s(api.get('/api/program_center/collect/resetpassword')),
    s(api.get('/api/program_center/collect/validate/password')),
    s(api.put('/api/program_center/collect/validate/password', {})),
    s(api.get('/api/program_center/config/change/password')),
    s(api.put('/api/program_center/config/token', {})),
    s(api.get('/api/program_center/dingding/sync/organization/register/callback/enable')),
    s(api.post('/api/program_center/invoke/token', {})),
    s(api.get('/api/program_center/invoke/flag/client/client/token/token/execute')),
    s(api.delete('/api/program_center/adminlogin')),
    s(api.put('/api/program_center/tokenthreshold/update', {})),
    s(api.get('/api/program_center/captcha/v2/create/width/0/height/0')),
    s(api.get('/api/program_center/captcha/0/validate/answer/0')),
    s(api.get('/api/program_center/code/create/mobile/0')),
    s(api.get('/api/program_center/code/validate/mobile/0/answer/0')),
    s(api.get('/api/program_center/code/validate/mobile/0/answer/0/cascade')),
    s(api.post('/api/program_center/code/list/paging/0/size/0', {})),
    s(api.delete('/api/program_center/collect/name/0/mobile/0/code/0')),
    s(api.put('/api/program_center/collect/resetpassword', {})),
    s(api.post('/api/program_center/config/change/password', {})),
    s(api.get('/api/program_center/dingding/sync/organization/register/callback/0')),
    s(api.post('/api/program_center/invoke/0/client/0/token/0/execute', {})),
  ])
}
</script>
