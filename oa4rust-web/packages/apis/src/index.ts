...
export const attendanceControlApi = {
  ...
  v2MyStatistic: (data: unknown) => api.post('/api/attendance/assemble/control/v2/my/statistic', data),
  v2MyDetailList: (data: unknown) => api.post('/api/attendance/assemble/control/v2/my/detail/list', data),
