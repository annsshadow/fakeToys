...
export const authApi = {
  login: (data: { credential: string; password: string; captchaId?: string; captchaAnswer?: string }) =>
    api.post<never>('/jaxrs/authentication/login', data, { requireAuth: false, discardResponse: true }),
  logout: () => api.post('/jaxrs/authentication/logout', null, { requireAuth: false, discardResponse: true }),
  who: () => api.get<import('@oa4rust/sdk').O2User>('/jaxrs/authentication/who', { requireAuth: false }),
  refresh: () => api.post<never>('/jaxrs/authentication/refresh', null, { requireAuth: false, discardResponse: true }),
  captcha: () => api.get<{ image: string; id: string }>('/jaxrs/authentication/captcha', { requireAuth: false }),
  captchaSize: (w: number, h: number) =>
    api.get<{ image: string; id: string }>(`/jaxrs/authentication/captcha/width/${w}/height/${h}`, {
      requireAuth: false,
    }),
...
export const imApi = {
  ...
  messageList: (p: number, s: number, cid?: string) =>
    api.post(`/jaxrs/message/assemble/communicate/im/msg/list/${p}/${s}`, { conversationId: cid }),
...
export const processServiceApi = {
  ...
  applicationDict: (flag: string) => api.get(`/jaxrs/processplatform/service/processing/applicationdict/${flag}`),
...
export const queryViewApi = {
  ...
  executeV2: (view: string, params?: unknown) => api.post(`/jaxrs/queryview/execute/v2/${view}`, params),
  ...
  importModelList: (query: string, flag: string) => api.get(`/jaxrs/queryview/importmodel/list/${query}/${flag}`),
  importModelExecute: (data: unknown) => api.post('/jaxrs/queryview/importmodel/execute', data),
  moreLikeThis: (params: unknown) => api.post('/jaxrs/queryview/morelikethis', params),
  neural: (params: unknown) => api.post('/jaxrs/queryview/neural', params),
  search: (keyword: string) => api.get('/jaxrs/queryview/search', { params: { keyword } }),
  stat: (params: unknown) => api.post('/jaxrs/queryview/stat', params),
  statement: (params: unknown) => api.post('/jaxrs/queryview/statement', params),
  tableList: (page: number, size: number) => api.post(`/jaxrs/queryview/table/list/paging/${page}/${size}`, {}),
  tableRow: (flag: string, rowId: string) => api.get(`/jaxrs/queryview/table/row/${flag}/${rowId}`),
  viewDetail: (id: string) => api.get(`/jaxrs/queryview/view/${id}`),
  viewList: (page: number, size: number) => api.post(`/jaxrs/queryview/view/list/paging/${page}/${size}`, {}),
...
export const programCenterApi = {
  ...
  // Market 市场
  marketList: (page: number, size: number) => api.post(`/jaxrs/program_center/market/list/paging/${page}/${size}`, {}),
  marketGet: (flag: string) => api.get(`/jaxrs/program_center/market/${flag}`),
  // Module 模块
  moduleList: () => api.get('/jaxrs/program_center/module/list'),
  moduleInvoke: (flag: string, data: unknown) => api.post(`/jaxrs/program_center/invoke/${flag}`, data),
  // Schedule 计划任务
...
export const mindApi = {
  ...
  mindList: (id: string, page: number) => api.get(`/jaxrs/mind/mind/list/${id}/${page}`),
  mindDetail: (id: string) => api.get(`/jaxrs/mind/mind/${id}`),
  mindSave: (data: unknown) => api.post('/jaxrs/mind/assemble/control/mind/save', data),
  mindVersionList: (id: string) => api.get(`/jaxrs/mind/mind/list/${id}/version`),
  mindVersion: (id: string, version: string) => api.get(`/jaxrs/mind/mind/version/${id}/${version}`),
  ...
  mindRestore: (id: string) => api.post(`/jaxrs/mind/assemble/control/mind/restore/${id}`, null),
  mindDelete: (id: string) => api.delete(`/jaxrs/mind/assemble/control/mind/${id}/destorymind`),
  mindIcon: (id: string, size: number) => api.get(`/jaxrs/mind/assemble/control/mind/${id}/icon/size/${size}`),
  mindShare: (id: string) => api.post(`/jaxrs/mind/assemble/control/mind/share/${id}`, null),
  mindUnshare: (id: string) => api.post(`/jaxrs/mind/assemble/control/mind/share/${id}/cancel`, null),
...
export const documentApi = {
  ...
  draftList: (page: number, size: number) => api.post(`/jaxrs/document/draft/list/paging/${page}/${size}`, {}),
...
export const queryDesignerApi = {
  ...
  iconGet: (query: string, flag: string) => api.get(`/jaxrs/query/assemble/designer/icon/${query}/${flag}`),
  ...
  importModelEdit: (id: string, data: unknown) =>
    api.put(`/jaxrs/query/assemble/designer/importmodel/edit/${id}`, data),
...
export const viewApi = {
  ...
  viewData: (id: string, params?: unknown) => api.post(`/jaxrs/view/viewdata/${id}`, params ?? {}),
...
export const fileInfoApi = {
  ...
  edit: (id: string, docId: string, data: unknown) => api.put(`/jaxrs/fileinfo/edit/${id}/doc/${docId}`, data),
  ...
  upload: (formData: FormData, docId: string) => api.upload(`/jaxrs/fileinfo/upload/document/${docId}`, formData),
  updateContent: (id: string, data: unknown) => api.put(`/jaxrs/fileinfo/update/${id}/content`, data),
  batchDownload: (docId: string, site: string) => api.get(`/jaxrs/fileinfo/batch/download/doc/${docId}/site/${site}`),
...
export const organizationControlApi = {
  ...
  update: (type: string, flag: string, data: unknown) =>
    api.put(`/jaxrs/organization/assemble/control/${type}/${flag}`, data),
...
export const attendanceControlApi = {
  ...
  auditAppeal: (id: string, data: unknown) =>
    api.put(`/jaxrs/attendance/assemble/control/attendanceappealInfo/audit/${id}`, data),
  ...
  attendanceadmin: () => api.get('/jaxrs/attendance/assemble/control/attendanceadmin'),
  attendanceadminX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendanceadmin/${id}`),
  attendanceappealInfoAudit: (id: string, data: unknown) =>
    api.put(`/jaxrs/attendance/assemble/control/attendanceappealInfo/audit/${id}`, data),
  attendanceappealInfoCheck: () => api.get('/jaxrs/attendance/assemble/control/attendanceappealInfo/check'),
  attendanceappealInfo: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendanceappealInfo/${id}`),
  attendanceconfigList: () => api.get('/jaxrs/attendance/assemble/control/attendanceconfig/list'),
  attendanceconfigSave: (data: unknown) => api.post('/jaxrs/attendance/assemble/control/attendanceconfig/save', data),
  attendancedetail: () => api.get('/jaxrs/attendance/assemble/control/attendancedetail'),
  attendancedetailAnalyse: (start: string, end: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendancedetail/analyse/${start}/${end}`),
  attendancedetailRecive: () => api.get('/jaxrs/attendance/assemble/control/attendancedetail/recive'),
  attendancedetailReciveSingle: () => api.get('/jaxrs/attendance/assemble/control/attendancedetail/reciveSingle'),
  attendancedetailX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendancedetail/${id}`),
  attendanceemployeeconfig: () => api.get('/jaxrs/attendance/assemble/control/attendanceemployeeconfig'),
  attendanceemployeeconfigX: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendanceemployeeconfig/${id}`),
  attendanceimportfileinfoX: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendanceimportfileinfo/${id}`),
  attendanceschedulesetting: () => api.get('/jaxrs/attendance/assemble/control/attendanceschedulesetting'),
  attendanceschedulesettingX: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendanceschedulesetting/${id}`),
  attendanceselfholiday: () => api.get('/jaxrs/attendance/assemble/control/attendanceselfholiday'),
  attendanceselfholidayX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendanceselfholiday/${id}`),
  attendancesetting: () => api.get('/jaxrs/attendance/assemble/control/attendancesetting'),
  attendancesettingX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendancesetting/${id}`),
  attendancestatisticalcycle: () => api.get('/jaxrs/attendance/assemble/control/attendancestatisticalcycle'),
  attendancestatisticalcycleX: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendancestatisticalcycle/${id}`),
  attendancestatisticrequirelog: () => api.get('/jaxrs/attendance/assemble/control/attendancestatisticrequirelog'),
  attendancestatisticrequirelogX: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendancestatisticrequirelog/${id}`),
  attendanceworkdayconfig: () => api.get('/jaxrs/attendance/assemble/control/attendanceworkdayconfig'),
  attendanceworkdayconfigFilter: () => api.get('/jaxrs/attendance/assemble/control/attendanceworkdayconfig/filter'),
  attendanceworkdayconfigX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendanceworkdayconfig/${id}`),
  selfholidaysimple: () => api.get('/jaxrs/attendance/assemble/control/selfholidaysimple'),
  v2Groupschedule: () => api.get('/jaxrs/attendance/assemble/control/v2/groupschedule'),
  v2Leave: () => api.get('/jaxrs/attendance/assemble/control/v2/leave'),
  attendanceappealInfoX: (id: string) => api.get(`/jaxrs/attendance/assemble/control/attendanceappealInfo/${id}`),
  attendanceadminListAll: () => api.get('/jaxrs/attendance/assemble/control/attendanceadmin/list/all'),
  attendanceappealInfoFilterList: (page: number, size: number) =>
    api.get(`/jaxrs/attendance/assemble/control/attendanceappealInfo/filter/list/${page}/${size}`),
  attendanceappealInfoManagerList: (page: number, size: number) =>
    api.get(`/jaxrs/attendance/assemble/control/attendanceappealInfo/manager/list/${page}/${size}`),
  attendanceappealInfoWorkflowAppeal: () =>
    api.get('/jaxrs/attendance/assemble/control/attendanceappealInfo/workflow/appeal'),
  attendanceappealInfoWorkflowSync: () =>
    api.post('/jaxrs/attendance/assemble/control/attendanceappealInfo/workflow/sync', null),
  attendancedetailAnalyseId: (id: string) =>
    api.get(`/jaxrs/attendance/assemble/control/attendancedetail/analyse/id/${id}`),
  attendancedetailAnalyseRedo: () => api.post('/jaxrs/attendance/assemble/control/attendancedetail/analyse/redo', null),
  attendancedetailFilterListTopUnit: () =>
    api.get('/jaxrs/attendance/assemble/control/attendancedetail/filter/list/topUnit'),
  attendancedetailFilterListUnit: () => api.get('/jaxrs/attendance/assemble/control/attendancedetail/filter/list/unit'),
  attendancedetailFilterListUser: () => api.get('/jaxrs/attendance/assemble/control/attendancedetail/filter/list/user'),
  attendancedetailListPersonsNonesign: () =>
    api.get('/jaxrs/attendance/assemble/control/attendancedetail/list/persons/nonesign'),
  attendancedetailMobileFilterList: () =>
    api.get('/jaxrs/attendance/assemble/control/attendancedetail/mobile/filter/list'),
...
export const portalSurfaceApi = {
  ...
  dictX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/dict/${flag}`),
  fileX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/file/${flag}`),
  getFull: (id: string) => api.get(`/jaxrs/portal/assemble/surface/get/${id}`),
  inputCompare: () => api.get('/jaxrs/portal/assemble/surface/input/compare'),
  inputCover: () => api.get('/jaxrs/portal/assemble/surface/input/cover'),
  inputCreate: () => api.post('/jaxrs/portal/assemble/surface/input/create', null),
  listAll: () => api.get('/jaxrs/portal/assemble/surface/list/all'),
  outputList: () => api.get('/jaxrs/portal/assemble/surface/output/list'),
  page: (id: string) => api.get(`/jaxrs/portal/assemble/surface/page/${id}`),
  pageCreate: (data: unknown) => api.post('/jaxrs/portal/assemble/surface/page/create', data),
  pageX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/page/${flag}`),
  pageversionX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/pageversion/${flag}`),
  portalAll: () => api.get('/jaxrs/portal/assemble/surface/portal/all'),
  portalList: () => api.get('/jaxrs/portal/assemble/surface/portal/list'),
  portalX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/portal/${flag}`),
  portalcategoryList: () => api.get('/jaxrs/portal/assemble/surface/portalcategor y/list'),
  saveX: (id: string, data: unknown) => api.put(`/jaxrs/portal/assemble/surface/save/${id}`, data),
  scriptX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/script/${flag}`),
  scriptversion: (id: string) => api.get(`/jaxrs/portal/assemble/surface/scriptversion/${id}`),
  templatepage: () => api.get('/jaxrs/portal/assemble/surface/templatepage'),
  templatepageList: () => api.get('/jaxrs/portal/assemble/surface/templatepage/list'),
  templatepageX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/templatepage/${flag}`),
  widget: () => api.get('/jaxrs/portal/assemble/surface/widget'),
  widgetX: (flag: string) => api.get(`/jaxrs/portal/assemble/surface/widget/${flag}`),
...
export const messageCommunicateApi = {
  ...
  imConversationUpdate: (id: string, data: unknown) =>
    api.put(`/jaxrs/message/assemble/communicate/im/conversation/${id}`, data),
...
// ─────────────────────────────────────────────────────────────
export const aiApi = {
  chatList: (page: number, size: number) => api.get(`/jaxrs/ai_assemble_control/chat/list/paging/${page}/${size}`),
  ...
  chatDelete: (clueId: string) => api.delete(`/jaxrs/ai_assemble_control/chat/delete/${clueId}`),
  ...
  configUpdateMcp: (flag: string, data: unknown) =>
    api.put(`/jaxrs/ai_assemble_control/config/update/mcp/${flag}`, data),
  configUpdateModel: (flag: string, data: unknown) =>
    api.put(`/jaxrs/ai_assemble_control/config/update/model/${flag}`, data),
  ...
  fileList: (page: number, size: number) => api.get(`/jaxrs/ai_assemble_control/file/list/paging/${page}/${size}`),
  ...
  indexList: (page: number, size: number) => api.get(`/jaxrs/ai_assemble_control/index/list/paging/${page}/${size}`),
...
export const roleApi = {
  ...
  listNext: (flag: string, count: number) => api.get(`/jaxrs/role/list/${flag}/next/${count}`),
  listPrev: (flag: string, count: number) => api.get(`/jaxrs/role/list/${flag}/prev/${count}`),
