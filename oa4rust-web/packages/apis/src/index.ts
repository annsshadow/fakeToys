...
export const attendanceControlApi = {
  ...
  attendanceappealInfoAudit: (id: string, data: unknown) => api.put("/jaxrs/attendance/assemble/control/attendanceappealInfo/audit/" + id, data),
  ...
  attendancedetailAnalyse: (start: string, end: string) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/" + start + "/" + end),
  ...
  attendanceemployeeconfigX: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendanceemployeeconfig/" + id),
  attendanceimportfileinfoX: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendanceimportfileinfo/" + id),
  attendanceschedulesetting: () => api.get("/jaxrs/attendance/assemble/control/attendanceschedulesetting"),
  attendanceschedulesettingX: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendanceschedulesetting/" + id),
  ...
  attendancestatisticalcycleX: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendancestatisticalcycle/" + id),
  attendancestatisticrequirelog: () => api.get("/jaxrs/attendance/assemble/control/attendancestatisticrequirelog"),
  attendancestatisticrequirelogX: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendancestatisticrequirelog/" + id),
  attendanceappealInfoAudit: (id, data) => api.put("/jaxrs/attendance/assemble/control/attendanceappealInfo/audit/" + id, data),
  attendanceappealInfoCheck: () => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/check"),
  attendanceappealInfo: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/" + id),
  attendanceconfigList: () => api.get("/jaxrs/attendance/assemble/control/attendanceconfig/list"),
  attendanceconfigSave: (data) => api.post("/jaxrs/attendance/assemble/control/attendanceconfig/save", data),
  attendancedetail: () => api.get("/jaxrs/attendance/assemble/control/attendancedetail"),
  attendancedetailAnalyse: (start, end) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/" + start + "/" + end),
  attendancedetailRecive: () => api.get("/jaxrs/attendance/assemble/control/attendancedetail/recive"),
  attendancedetailReciveSingle: () => api.get("/jaxrs/attendance/assemble/control/attendancedetail/reciveSingle"),
  attendanceemployeeconfig: () => api.get("/jaxrs/attendance/assemble/control/attendanceemployeeconfig"),
  attendanceemployeeconfigX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceemployeeconfig/" + id),
  attendanceimportfileinfoX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceimportfileinfo/" + id),
  attendanceschedulesetting: () => api.get("/jaxrs/attendance/assemble/control/attendanceschedulesetting"),
  attendanceschedulesettingX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceschedulesetting/" + id),
  attendanceselfholiday: () => api.get("/jaxrs/attendance/assemble/control/attendanceselfholiday"),
  attendanceselfholidayX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceselfholiday/" + id),
  attendancesetting: () => api.get("/jaxrs/attendance/assemble/control/attendancesetting"),
  attendancesettingX: (id) => api.get("/jaxrs/attendance/assemble/control/attendancesetting/" + id),
  attendancestatisticalcycle: () => api.get("/jaxrs/attendance/assemble/control/attendancestatisticalcycle"),
  attendancestatisticalcycleX: (id) => api.get("/jaxrs/attendance/assemble/control/attendancestatisticalcycle/" + id),
  attendancestatisticrequirelog: () => api.get("/jaxrs/attendance/assemble/control/attendancestatisticrequirelog"),
  attendancestatisticrequirelogX: (id) => api.get("/jaxrs/attendance/assemble/control/attendancestatisticrequirelog/" + id),
  ...
  attendanceworkdayconfigX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceworkdayconfig/" + id),
  selfholidaysimple: () => api.get("/jaxrs/attendance/assemble/control/selfholidaysimple"),
  v2Group: () => api.get("/jaxrs/attendance/assemble/control/v2/group"),
  ...
  attendanceappealInfoAudit: (id, data) => api.put("/jaxrs/attendance/assemble/control/attendanceappealInfo/audit/" + id, data),
  attendanceappealInfoCheck: () => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/check"),
  attendanceappealInfoX: (id) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/" + id),
  attendanceconfigList: () => api.get("/jaxrs/attendance/assemble/control/attendanceconfig/list"),
  attendanceconfigSave: (data) => api.post("/jaxrs/attendance/assemble/control/attendanceconfig/save", data),
  attendancedetail: () => api.get("/jaxrs/attendance/assemble/control/attendancedetail"),
  attendancedetailAnalyse: (start, end) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/" + start + "/" + end),
  ...
  attendanceappealInfoFilterList: (page, size) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/filter/list/" + page + "/" + size),
  attendanceappealInfoManagerList: (page, size) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/manager/list/" + page + "/" + size),
  attendanceappealInfoWorkflowAppeal: () => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/workflow/appeal"),
  attendanceappealInfoWorkflowSync: () => api.post("/jaxrs/attendance/assemble/control/attendanceappealInfo/workflow/sync", null),
  attendancedetailAnalyse: (start, end) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/" + start + "/" + end),
  attendancedetailAnalyseId: (id) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/id/" + id),
  attendancedetailAnalyseRedo: () => api.post("/jaxrs/attendance/assemble/control/attendancedetail/analyse/redo", null),
  attendancedetailFilterListTopUnit: () => api.get("/jaxrs/attendance/assemble/control/attendancedetail/filter/list/topUnit"),
