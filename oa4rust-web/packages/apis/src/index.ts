...
export const attendanceControlApi = {
  ...
  attendanceappealInfoFilterList: (page: number, size: number) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/filter/list/" + page + "/" + size),
  attendanceappealInfoManagerList: (page: number, size: number) => api.get("/jaxrs/attendance/assemble/control/attendanceappealInfo/manager/list/" + page + "/" + size),
  ...
  attendancedetailAnalyseId: (id: string) => api.get("/jaxrs/attendance/assemble/control/attendancedetail/analyse/id/" + id),
